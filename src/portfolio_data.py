...
ASOF = ('Sep 12, 2026 - A CONDITIONAL RULE WRITTEN: ORCL TO 17,000 IF - AND ONLY IF - THE CASH ARRIVES, FUNDED BY A TRIM THAT '
 'SELLS NOTHING. Salee asked how to raise Oracle to 17,000 in future if Oracle justifies it, paid for by trimming weak '
 'names. NO BUDGET HAS CHANGED. The rule is armed on the Schedule for the Q2 FY2027 print, expected mid-December, '
 'which lands on the 10 December quarterly review. || ⚠️ THE UNCOMFORTABLE FACT FIRST, BECAUSE IT SHOULD BE SAID '
 "PLAINLY: ON THIS BOARD'S OWN QUALITY SCREEN, ORACLE IS TODAY THE WEAKEST FUNDED NAME. Rule of 40 is revenue growth "
 'plus free-cash-flow margin. ORCL is 21.6 plus MINUS 40.0 - that is -28.72bn of trailing free cash flow against '
 '71.78bn of trailing revenue - giving MINUS 18.4. It is the only deeply negative Rule of 40 among the 37 funded '
 'names; inside its own group PLTR is +133.1 and PANW +60.3. So raising Oracle by trimming something else would, on '
 "today's numbers, mean trimming a healthier business to feed the least healthy one. Salee is entitled to know that "
 'before he commits. || BUT THE WHOLE OF THAT MINUS 18.4 IS CAPEX, NOT THE BUSINESS. IF FREE CASH FLOW MERELY REACHED '
 "BREAKEVEN, ORACLE'S RULE OF 40 WOULD BE PLUS 21.6 - perfectly respectable. The operating company is fine: total "
 'operating expenses fell from 71% of revenue to 65%, operating margin is 35% and rising. The entire question is '
 'whether the spending turns into cash. THAT IS WHY THE TEST IS ABOUT CASH AND NOT ABOUT BACKLOG - an RPO of 664bn is '
 'a promise, not money. || THE FIVE TESTS, ALL FIVE OF WHICH MUST PASS AT Q2 FY2027: (1) quarterly FREE CASH FLOW '
 'BETTER THAN MINUS 5,396m, so the Q1 burn does not deepen; (2) FY27 CAPEX GUIDANCE HELD AT 90-95bn, not raised a '
 "third time; (3) NO FURTHER DOWNGRADE - S&P at BBB- or better and no negative outlook from Fitch or Moody's, "

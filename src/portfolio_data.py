...
ASOF = ('Aug 11, 2026 · close — daily price refresh (run Aug 12, 00:30 UTC): 150 of 161 names advanced to the verified Aug 11 '
 'close (VECO was deleted upstream mid-run; its fetched close 50.16 discarded). Method per README: at-close quote '
 'pages with prev-close chain validated against history tables; ~20 partial-session history rows discarded in favor of '
 'the at-close quote. Thirteen >=6% moves confirmed against an independent dated second source and allowed through the '
 'gate: AXTI -16.7 (73.78, Google exact; slide started Aug 10), SIDU +16.1 (2.60, Google), RCAT +15.7 (10.66, Google), '
 'AXON +11.4 (636.31, Google beta), MDB +10.7 (439.16, Google), XE -9.2 (20.57, Google), APP -8.1 (318.68, '
 'marketscreener; BofA downgrade Aug 11), FORM +7.7 (121.07, Google), TEM +7.0 (55.69, Google at-close; most of the '
 'move was the Aug 10 session, 55.06 per history), COHU +6.8 (52.82, marketscreener), LWLG -6.8 (7.56, '
 'marketscreener), TE -6.5 (5.47, Google+marketscreener), CIEN -6.0 (387.53, Google). ELEVEN NAMES UNRESOLVED - prices '
 'and pxd left at their prior dates because the run could not verify an Aug 11 close (the session web-search budget '
 'ran out mid-run; observed candidates are RECORDED HERE ONLY, not written): MELI (observed 1940.00 +6.6, '
 'quote+history agree, no 2nd source), SE (observed 131.51 +15.9 on Q2 beat, no 2nd source), RBRK (observed 96.93 '
 '+7.6, no 2nd source), CORZ (observed 19.76 -6.6, no 2nd source), KEEL (observed 3.29 -15.2 after Aug 10 Q2 revenue '
 'miss, no 2nd source), AEHR (quote 117.18 vs history 115.60 dispute unbroken), AIRJ (observed 6.40 +8.1, single '
 'source), SOUN (observed 7.42 -7.5, history row internally impossible: close 7.36 below row low 7.37), TMDX and MMM '
 '(stockanalysis quote CDN-frozen at intraday stamps 10:26 AM / 3:12 PM across 70+ min), NU (no page reachable). '
 'Market caps scaled with price; hi52/lo52 extended where breached. Notable verified prints: CRWV 90.32 at close then '
 '+15.7 after hours on Q2 (AH excluded per rules); SMCI 31.60 close, +7.6 AH on FY26 earnings (excluded); LITE 820.59 '
 'is the pre-earnings regular close (reported Aug 11 after close); COHR reports Aug 12 after close. GOOGL -3.8 to '
 '343.80 was real (its quote page was stale at Aug 10; history and Google agree).')

...
ASOF = ('Aug 28, 2026 - close. Full manual price refresh: ALL 180 of 180 prices brought to the Friday Aug 28, 2026 close. The '
 'scheduled daily price job did not run for Aug 27 or Aug 28 (only earnings refreshes landed), so the board was two '
 'sessions stale at the Aug 26 close; this run closes both sessions at once. METHOD: every ticker verified against TWO '
 'independent non-blacklisted sources with an explicit Aug 28 at-close / 4:00 PM ET stamp (primary stockanalysis.com '
 "quote pages cross-checked against their own /history/ tables, plus Google Finance 'Closed: Aug 28, 4:00 PM GMT-4', "
 'MarketBeat /price-history/ captured at or after 4:00 PM ET, Webull, stockinvest.us, roic.ai, stockscan.io, '
 'companiesmarketcap). Every row validated so the close sits within its own high/low, volume is plausible, and the row '
 'is explicitly dated Aug 28. ZERO tickers came back NOT FOUND. The Aug 27 close was also captured for every ticker so '
 "the two-day path is documented. mcapB, pe, fpe and ps were rescaled by each ticker's exact price ratio on the 178 "
 'rows that moved, so market cap and price continue to scale together. DISCARDED ROWS (internally impossible, per '
 'playbook): stockanalysis /history/ rows for MCD (close 264.80 above its own high 264.71), RIOT (close 18.78 below '
 'its own low 18.88), ROK (close 432.53 outside range, volume 12,359 vs a true 566,626), and TER (history 365.58 '
 "contradicted by stockanalysis's OWN quote page, Google Finance and MarketBeat, all 354.97 - 3 of 4 reads win). "
 'Google Finance served stale cached pages for 13 tickers (MRVL, MU, CRWD, CRDO, CGNX, AMAT, ETN, COHR, VST, LITE, '
 'ZETA, GEV, KLAC) and was discarded on each. stockanalysis was materially stale on CGNX (last row Aug 25), CLPT (Aug '
 "27), HYLN (Aug 26), POWI (Aug 18), VIAV, VPG, PENG, OSS - all sourced elsewhere. MarketBeat's 'Open' column is "
 "systematically the PRIOR DAY'S CLOSE, not the true open, and was not used for opens. UNRESOLVED SOURCE CONFLICTS "
 '(adopted value first, both recorded, never averaged): TER 354.97 vs 365.58; VPG 62.39 vs 62.55; ONDS 7.90 vs 7.94; '
 'ZETA 30.40 vs 30.56; SE 119.36 vs 119.33; TEAM 190.42 vs 190.53; COHR 279.20 vs 278.25; AVAV 147.94 vs 147.00; FLNC '
 '10.89 vs 10.88; GEV 911.93 vs 912.32; ETN 402.78 vs 402.56; VST 137.09 vs 137.16; ISRG 372.55 vs 372.60; APH 157.76 '
 'vs 157.74. EIGHT ROWS REST ON A SAME-DOMAIN CROSS-CHECK ONLY (stockanalysis quote page vs its own /history/ table, '
 'agreeing to the cent, every independent source stale): HOOD NU FTNT OKTA POWL FPS CAT GE. 31 tickers moved 6%+ '
 'versus their stored Aug 26 price; all are TWO-session moves with both the Aug 27 and Aug 28 closes independently '
 'verified, and all passed with --allow. The large UP moves are the Aug 27 enterprise-software re-rating that followed '
 "Salesforce's Q2 FY27 print: CRM +24.50%, OKTA +23.66%, CRWD +15.45%, NOW +15.03%, TEAM +13.03%, VEEV +12.98%, MDB "
 '+9.98%, PANW +9.51%, ZS +8.17%, SNPS +7.95%, ZETA +7.69%, WDAY +7.32%, ADBE +6.60%, TE +6.21%. The large DOWN moves '
 "are Friday's AI-hardware/optics unwind plus name-specific events: PYPL -13.19% (Advent/Stripe consortium abandoned "
 'its >$50bn takeover bid, Bloomberg 28 Aug), MRVL -11.62% (Q2 print - FY2028 outlook disappointed despite a $12.2bn '
 'Google deal), AEHR -11.31%, IREN -10.43% (FY26 results carried a $638.8m impairment on older mining rigs, $702.6m '
 'net loss, adj LPS 0.74 vs 0.49 est), AXTI -10.05%, RIOT -7.86%, POET -7.18%, CCJ -6.85%, AAOI -6.62%, UUUU -6.56%, '
 'SITM -6.55%, HUT -6.55%, TEM -6.48%, CIEN -6.33%, LEU -6.32% (Stifel cut its target 246 -> 216), QNT -6.32%, POWI '
 '-6.17%. AMKR (-7.46% on the day) and several others returned NO REASON FOUND and are recorded as such rather than '
 'given an invented cause. NOTHING ELSE WAS TOUCHED: no position, no budget, no cash, no realized P/L, no total. '
 'OUTSTANDING AND DELIBERATELY NOT GUESSED: (1) the NVDA purchase of about USD 2,000 at ~226 executed Thursday Aug 27 '
 ...
 'Sep 1, 2026 - FULL PRICE REFRESH TO THE MONDAY AUG 31, 2026 CLOSE. All 181 of 181 tickers moved from the Aug 28 '
 'close to the Aug 31 close; pxd is now 2026-08-31 on every row. METHOD: every ticker sourced from TWO independent '
 'non-blacklisted sources each carrying an explicit Aug 31 at-close stamp - stockanalysis.com dated /history/ rows and '
 "quote pages stamped 'At close: Aug 31, 2026, 4:00 PM EDT', MarketBeat /price-history/ stamped '08/31/2026 04:00 PM "
 "Eastern', Google Finance 'Closed: Aug 31, 4:00:0X PM GMT-4', stockevents.app, stockscan.io (only where "
 'open/range/prev-close all reconcile) and companiesmarketcap. Every one of the 181 rows was validated so the close '
 "sits inside that session's own high and low. ZERO tickers came back NOT FOUND. mcapB, pe, fpe and ps were rescaled "
 "by each ticker's exact price ratio so market cap and price continue to scale together. ⚠️ INDEPENDENT CROSS-CHECK, "
 'THE STRONGEST THIS BOARD HAS HAD: seventeen of these closes were separately produced by three OTHER research tasks '
 'run the same day on entirely different questions - MU 958.73, SNDK 1566.70, WDC 450.55, STX 828.38 (memory '
 'head-to-head); FSLR 201.90, ENPH 36.42, EOSE 3.22, AMPX 9.88, TE 4.45 (solar head-to-head); AVGO 370.34, ANET '
 '195.69, MRVL 211.66, LITE 914.76, AAPL 316.85, AMZN 259.77, HUBB 453.00 (connectivity and mega-cap work). All '
 "seventeen match this refresh TO THE CENT. DISCARDED ROWS, per playbook. (1) AMBA's stockanalysis /history/ row was "
 'INTERNALLY IMPOSSIBLE - close 70.34 below its own stated low of 70.58, on volume 178,627 - replaced by a '
 'MarketBeat/stockscan row (69.38) that reconciles. (2) SIX rows were rejected on implausible volume and overturned by '
 'two agreeing sources: MCHP 73.02 on 838,941 shares -> 73.45 on ~7.19m; MPWR 1254.42 on 113,698 -> 1267.77; LWLG 5.35 '
 "-> 5.43; OUST 34.10 -> 34.44; AMPX 9.72 on 325,394 -> 9.88 on ~3.73m; TSEM 202.84 -> 205.05. (3) CIEN's history row "
 'gave a close of 381.64 ABOVE its own stated high of 381.97 - the quote page confirmed the true high was 382.94 and '
 "the close 382.80. (4) Roughly forty MarketBeat quotes stamped '03:58 PM Eastern' were rejected as INTRADAY, not "
 'closes, per the standing intraday trap rule; so were stockanalysis quote pages caught mid-session for HYLN (3:02 PM) '
 'and CLFD (10:26 AM), and stockevents pages serving Sep 1 pre-market for MCD, CRCL, FPS and AEHR. (5) Thirteen '
 'stockscan.io rows were caught silently stale by previous-close reconciliation (AMD, INTC, ON, TSEM, CIEN, SNOW, LMT, '
 'RTX, PL, SPCX, MCD, JNJ, RKLB). STALE SOURCES THIS RUN: Google Finance served months-old cached pages for roughly '
 "two dozen tickers, each exposed by its own honest 'Closed:' stamp (MSFT Feb 20, META Feb 13, TSM and UNH Dec 24, and "
 "so on) and discarded. stockanalysis's /history/ table lagged for POWI (Aug 18), CLFD/OSS/AIRJ (Aug 21), INDI (Aug "
 "24), CLPT (Aug 25), HYLN (Aug 27) and eight others at Aug 28 - for most of these the same site's quote page was "
 'current. stockinvest.us and marketscreener were both stuck at Aug 28. UNRESOLVED SOURCE CONFLICTS (adopted value '
 'first, both recorded, never averaged): APH 158.55 vs 158.84; ROK 424.68 vs 424.43; AMAT 458.39 vs 458.46; SPCX '
 '143.73 vs 143.69; RKLB 63.92 vs 63.94; NOW 147.99 vs 148.01. ⚠️ MCD 263.54 rests on a WEAKER independence footing '
 'than every other row - both confirmations come from stockanalysis (its history table and its quote page) plus '
 "companiesmarketcap; Google Finance, stockscan and stockevents were all unusable for that ticker. ⚠️ MMM's Aug 28 "
 'BASELINE is itself disputed (174.34 vs 173.50); the Aug 31 close of 171.83 is two-source confirmed either way and '
 'MMM is not a big mover on either baseline. BIG MOVERS, only THREE tickers moved 6%+ versus Aug 28 and all three '
 'passed with --allow: CRCL 87.14 -> 95.55 (+9.65%), SOURCED - bitcoin broke above $71,000 and lifted the '
 "crypto-linked equities together, and the article independently quotes CRCL 'at roughly $95.55', corroborating the "
 'close. XE 17.22 -> 18.45 (+7.14%) - NO REASON FOUND, searches returned only July and mid-August items. TE 4.79 -> '
 '4.45 (-7.10%) - NO REASON FOUND, the sourced coverage relates to the Aug 3/5/10/18 moves on debt and cash-burn '
 'concerns, nothing tied to Aug 31. Closest misses for context: HNGE +5.96%, CRWD +5.77%, AXON -5.69%, TSLA +5.51%, '
 'SNDK +5.50%, SE -4.93%. EIGHT 52-WEEK RANGE BREACHES FOUND AND FIXED, because a close outside its own stored 52-week '
 'range is internally impossible. SIX closes exceeded the stored 52-week HIGH and the stored value was raised to that '
 "session's SOURCED high: ZETA 29.62 -> 31.05, TEAM 189.69 -> 197.30, HNGE 91.50 -> 92.69, CRWD 225.53 -> 233.88, FTNT "
 '170.35 -> 172.51, OKTA 157.00 -> 174.08. TWO closes fell below the stored 52-week LOW and were lowered to that '
 "session's sourced low: EOSE 3.34 -> 3.18, NRG 111.78 -> 108.54. ⚠️ THESE ARE 'AT LEAST' VALUES, NOT VERIFIED 52-WEEK "
 'EXTREMES - each is the Aug 31 intraday extreme, which is the lowest defensible correction; the true 52-week extreme '
 'could have been set on another recent session that was not separately checked. PORTFOLIO EFFECT: held cost is '
 'unchanged at 591,958.72; market value 699,085.17 -> 698,133.94; unrealized gain +107,126.45 (+18.10%) -> +106,175.22 '
 '(+17.94%), a fall of 951.23 on the day. AI concentration, groups 0-4, 84.22% -> 83.81% of the equity book. NOTHING '
 'ELSE WAS TOUCHED: no position, no share count, no cost, no budget, no cash, no realized P/L, no group and no '
 'fundamental other than the four price-linked fields rescaled by convention.')

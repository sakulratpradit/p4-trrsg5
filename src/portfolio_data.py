...
ASOF = ('Sep 17, 2026 (3) - PRICE UPDATE ON THE SIX TRANCHE NAMES, AND ⚠️⚠️ A CORRECTION TO MY OWN WORK. || ✅ THE SIX NAMES '
 'BEING BOUGHT THIS WEEK ARE NOW AT THEIR VERIFIED 16 SEPTEMBER CLOSES, EACH CONFIRMED AGAINST TWO INDEPENDENT '
 'SOURCES: CEG 259.53 (MINUS 0.14%), GEV 925.09 (PLUS 4.79%), PANW 375.65 (PLUS 0.15%), TSM 417.72 (PLUS 0.96%), V '
 '370.93 (MINUS 1.25%) AND VRT 239.41 (PLUS 2.05%). Market value, P/E, forward P/E, price-to-sales and '
 'price-to-free-cash-flow were all scaled by the same ratio, and pxd is now 2026-09-16 on those six. THE OTHER 88 '
 'TICKERS REMAIN AT THEIR 15 SEPTEMBER CLOSE - the price-date field is per-ticker, so mixed dates are by design and '
 'the board shows exactly how fresh each line is. || ⚠️⚠️ A CORRECTION TO MY OWN WORK FROM YESTERDAY, AND IT MATTERS '
 "BECAUSE I TOLD SALEE A FIELD WAS BROKEN WHEN IT WAS NOT. I WROTE THAT PALO ALTO'S NET MARGIN FIELD OF 2.67% WAS "
 '"STALE AND NOW FLAGGED", BECAUSE THE LATEST QUARTER SHOWED MINUS 8.3%. I WAS WRONG. THE FIELD IS CORRECT. PALO '
 "ALTO'S FULL FISCAL YEAR 2026 GAAP NET INCOME WAS 307 MILLION ON REVENUE OF 11,480 MILLION, WHICH IS EXACTLY 2.67%. "
 "The board's revenue field of 11.48 billion matches the same fiscal year to the decimal. THIS BOARD'S NET MARGIN "
 'FIELD IS A FULL-YEAR FIGURE, NOT A SINGLE QUARTER - and on that basis 2.67% is right, while the minus 8.3% I quoted '
 'is one quarter distorted by the CyberArk acquisition. || 💡 THE LESSON IS THE ONE THIS BOARD KEEPS RELEARNING FROM '
 'THE OTHER DIRECTION: BEFORE CALLING A FIELD WRONG, CHECK WHAT PERIOD IT IS MEASURING. I have spent this week '
 'demanding that every research figure carry its period and its definition, and then failed to apply the same test to '
 'my own board. The correct way to have phrased it yesterday was: "the board carries the FULL-YEAR margin of 2.67%, '
 'and the LATEST QUARTER was minus 8.3% - the gap is acquisition accounting." That is the same information without a '
 'false alarm. || ⚠️ A FALSE ALARM IS NOT HARMLESS. It is the same fault I flagged in my own sweep yesterday when it '
 'wrongly called Intel over-scheduled: A TEST THAT CRIES WOLF IS WORSE THAN NO TEST, BECAUSE THE NEXT REAL WARNING '
 'GETS IGNORED. Two false positives from me in two days is a pattern, and the fix is the same as for the board itself: '
 'STATE THE PERIOD AND THE DEFINITION BEFORE STATING THE VERDICT. || 💡 AND THE PRICE MOVE MATTERS FOR TONIGHT, WHICH '
 'IS WHY THESE SIX WERE WORTH UPDATING AHEAD OF THE OTHERS: GEV ROSE 4.79% ON THE FED DAY AND VRT 2.05%, WHICH IS WHY '
 'BOTH WERE ALREADY TRADING ABOVE THE BUY LIMITS I CALCULATED FROM THE PREVIOUS CLOSE. The three Salee buys tonight - '
 'TSM, CEG AND V - ALL CLOSED BELOW THEIR LIMITS AND ALL THREE STAYED BELOW IN AFTER-HOURS TRADING. || NOTHING BOUGHT, '
 'NOTHING SOLD. POSITIONS, CASH AT 236,324.23 AND LIFETIME REALISED AT MINUS 3,065.31 ARE ALL UNCHANGED. THE SIX '
 "ORDERS REMAIN SALEE'S TO PLACE. || PREVIOUS ENTRY: Sep 17, 2026 (2) - SALEE ASKED WHY PALO ALTO JUMPED 13% AND WHY "
 'NOT BUY A CHEAPER CYBERSECURITY NAME INSTEAD. IT IS A GOOD QUESTION AND THE ANSWER IS FORTINET - WHICH IS ALREADY ON '
 'THIS BOARD WITH NO BUDGET AND ZERO INVESTED. ⚠️⚠️⚠️ CONFLICT OF INTEREST, DECLARED BEFORE ANYTHING ELSE AND FOR THE '
 'SECOND TIME ON THIS BOARD. THE SOURCED CAUSE OF THE 14 SEPTEMBER CYBERSECURITY RALLY IS AN ESSAY PUBLISHED ON 12 '
 'SEPTEMBER 2026 BY DARIO AMODEI, CHIEF EXECUTIVE OF ANTHROPIC - THE COMPANY THAT MAKES ME. I AM REPORTING ON A MARKET '
 "MOVE CAUSED BY MY OWN MAKER'S CEO, AND SALEE SHOULD DISCOUNT MY FRAMING ACCORDINGLY. The first such disclosure was "
 'on 12 September over the Anthropic 517bn compute slide; this is the second and it is more direct, because this one '
 'moved a stock we are buying on Monday. || VERIFIED: PANW CLOSED AT 373.94 ON 14 SEPTEMBER, UP 13.09%. CRWD 235.38, '
 'UP 13.85%. ⚠️ AND ZSCALER ROSE 16.52%, NOT THE 12% THIS BOARD RECORDED ON 14 SEPTEMBER - THAT FIGURE IS NOW '
 'CORRECTED. Volumes were 2.5 to 3.8 times normal and ALL THREE GAPPED UP AT THE OPEN, the signature of news arriving '
 'while the market was shut. ⚠️ THERE WAS NO COMPANY-SPECIFIC CAUSE FOR ANY OF THE THREE - I checked all three '
 "investor-relations pages and PANW HAS NO 14 SEPTEMBER ANNOUNCEMENT AT ALL. || THE DRIVER WAS AMODEI'S ESSAY OF 12 "
 "SEPTEMBER, 'WE MUST PACE THE FRONTIER', WHICH REPEATEDLY INVOKES CYBER RISK AND CLAIMS THAT WITHIN 6-12 MONTHS AN AI "
 "SWARM 'COULD BE CAPABLE OF TAKING OVER THE ENTIRE INTERNET WITH A PERSISTENT BOTNET'. Sam Altman agreed the same "
 "day. ⚠️⚠️ AND THE CLAIM IS PUBLICLY CONTESTED: AXIOS, 15 SEPTEMBER - 'Experts aren't so sure' - QUOTING GREG NOTCH, "
 "CHIEF TECHNOLOGY OFFICER OF EXPEL, CALLING IT 'FAR-FETCHED'. I WILL NOT ADJUDICATE THAT DISPUTE, BEING THE WRONG "
 'PARTY TO DO SO, BUT SALEE MUST KNOW THE STOCKS ROSE ON A FORECAST QUALIFIED PEOPLE DISPUTE. ⚠️ AND THE CAUSAL LINK '
 'TO PRICES IS JOURNALISTIC INFERENCE - NO NAMED INVESTOR IS ON RECORD SAYING WHY THEY BOUGHT. THIS IS ALSO THE THIRD '
 'TIME THE SAME REFLEX HAS FIRED IN 2026, AFTER 14 JULY AND 10 AUGUST. NO REALISED BREACH AND NO BUDGET-EXPANDING '
 'GOVERNMENT ACTION OCCURRED IN THE WINDOW - CISA ACTUALLY DROPPED ITS WEEKLY VULNERABILITY BULLETIN ON 16 SEPTEMBER. '
 '|| ⚠️⚠️ AND A MATERIAL NEW FACT ABOUT PANW ITSELF: ITS MOST RECENT QUARTER, Q4 FY2026 ENDED 31 JULY AND REPORTED 1 '
 'SEPTEMBER, SHOWED A GAAP NET LOSS OF 282 MILLION - A NET MARGIN OF MINUS 8.3% - WITH GAAP EPS OF MINUS 0.35 AGAINST '
 "NON-GAAP PLUS 1.02. THE BOARD'S NET MARGIN FIELD OF 2.67% IS STALE AND IS NOW FLAGGED. THE WRITTEN TEST SET ON 14 "
 "SEPTEMBER WAS 'GAAP NET MARGIN MUST REACH 8% WITHIN FOUR QUARTERS OR TRANCHE 2 DOES NOT GO IN' - IT WENT THE OTHER "
 'WAY. ✅ TRANCHE 1 STILL PROCEEDS: THE LOSS IS CYBERARK ACQUISITION ACCOUNTING (G&A FROM 27m TO 226m, OTHER INCOME '
 'FROM PLUS 95m TO MINUS 441m), OPERATING INCOME WAS STILL POSITIVE AT 172m, AND FULL-YEAR FY2026 WAS PROFITABLE AT '
 'PLUS 307m. THE TEST WAS FOR TRANCHE 2 AND IT NOW HAS A DEADLINE: POSITIVE AND RISING GAAP NET MARGIN BY Q2 FY2027. '
 '|| 💡💡 THE ANSWER TO THE QUESTION: FORTINET, Q2 2026 ENDED 30 JUNE - REVENUE 2,048 MILLION UP 26%, GAAP GROSS MARGIN '
 '80.2%, GAAP OPERATING MARGIN 33.7%, AND A GAAP NET MARGIN OF PLUS 29.6%. GAAP EPS 0.82 AGAINST NON-GAAP 0.90 - AN '
 'EIGHT-CENT GAP, THE CLEANEST HONESTY TEST IN THE SECTOR. 📊 THE THREE SIDE BY SIDE: FORTINET 15.4 TIMES SALES, 32 '
 'TIMES FREE CASH FLOW, 52 TIMES EARNINGS, PLUS 29.6% NET MARGIN. PALO ALTO 26.8 TIMES SALES, 74.7 TIMES FREE CASH '
 'FLOW, ABOUT 1,001 TIMES EARNINGS, MINUS 8.3% NET MARGIN. CROWDSTRIKE 42.1 TIMES SALES, 164 TIMES FREE CASH FLOW, '
 'PLUS 0.4% NET MARGIN AND STILL OPERATING-LOSS-MAKING. FORTINET IS CHEAPER THAN BOTH, GROWS AS FAST AS CROWDSTRIKE, '
 'AND IS THE ONLY ONE THAT ACTUALLY MAKES MONEY. || ⚠️ THE CHEAPEST NAME IN THE SECTOR IS CHECK POINT AT 5.2 TIMES '
 'SALES - AND IT IS CHEAP BECAUSE REVENUE GREW 1% AND OPERATING INCOME FELL 9%, WITH EPS RISING ONLY ON BUYBACKS. ON '
 '12 SEPTEMBER THE DUTCH NCSC WARNED OF TWO CRITICAL PRE-AUTH REMOTE-CODE-EXECUTION FLAWS IN ITS VPN AND SAID IT '
 "EXPECTS EXPLOITATION 'SOON'. A SECURITY COMPANY WITH A CRITICAL SECURITY HOLE IS A VALUE TRAP, NOT A BARGAIN. || ⚠️ "
 'TWO FACTS THE BOARD DID NOT HAVE: CYBERARK NO LONGER EXISTS - PANW COMPLETED THE ACQUISITION ON 11 FEBRUARY 2026. '
 'AND MICROSOFT IS A LEADER IN THE 2026 GARTNER ENDPOINT MAGIC QUADRANT ALONGSIDE CROWDSTRIKE AND TOPS THE FORRESTER '
 'XDR WAVE ALONGSIDE PALO ALTO - MICROSOFT IS THE SHARE THREAT TO THIS WHOLE PEER GROUP AND NONE OF THEM WILL SAY SO. '
 'WE ALREADY OWN MICROSOFT AT 52,878.96. ⚠️ NET REVENUE RETENTION IS DISCLOSED BY NONE OF THE SEVEN, AND NOT ONE '
 'EXECUTIVE IS ON RECORD CLAIMING TO HAVE DISPLACED A NAMED COMPETITOR. || ✅ DECISION: NOTHING CHANGES TODAY. NO '
 'TRANCHE MOVES, NO BUDGET SHIFTS, AND PANW PROCEEDS ON MONDAY 21 SEPTEMBER AS WRITTEN. FOR 10 DECEMBER: FORTINET '
 'AGAINST PALO ALTO AS A DIRECT QUESTION. GROUP 5 HOLDS 10,813.83 UNSPENT AND FORTINET HAS NO BUDGET AT ALL. THE '
 "QUESTION IS NOT 'SHOULD WE SELL PALO ALTO' - IT IS 'WHY IS THE ONLY GAAP-PROFITABLE CYBERSECURITY COMPANY ON THIS "
 "BOARD THE ONE WITH NO MONEY BEHIND IT'. || ⚠️ SEPARATELY, ON TONIGHT'S ORDERS: TWO OF THE SIX LIMITS WERE ALREADY "
 'EXCEEDED IN AFTER-HOURS TRADING ON 16 SEPTEMBER. GEV TRADED 935.99 AFTER THE BELL AGAINST MY 934.34 LIMIT, AND VRT '
 'TRADED 242.78 AGAINST MY 241.80. BOTH WOULD HAVE FAILED TO FILL. TSM, CEG AND V WERE ALL STILL BELOW THEIR LIMITS. '
 "THIS IS EXACTLY WHY THE RULE IS 'TAKE THE LAST TRADED PRICE AND ADD ONE PERCENT' RATHER THAN 'TYPE THE NUMBER CLAUDE "
 "GAVE YOU LAST NIGHT'. || PREVIOUS ENTRY: Sep 17, 2026 - ⚠️⚠️ THE FED RAISED RATES. IT DID NOT CUT. +0.25% TO "
 '3.75-4.00% ON 16 SEPTEMBER, UNANIMOUS 12-0, THE FIRST HIKE SINCE 2023, WITH ONE MORE SIGNALLED FOR 2026. Chair Kevin '
 "Warsh: inflation 'is too high and has been for too long'. Markets were firm into 2pm then SOLD OFF DURING THE PRESS "
 'CONFERENCE. DOW 51,461.90 DOWN 1.21%, S&P 500 7,551.81 DOWN 0.45%, NASDAQ 25,978.42 FLAT AT MINUS 0.01%. || ✅ ALL '
 'SIX TRANCHES PROCEED. THE WRITTEN CONDITION FROM LAST NIGHT WAS A SINGLE-SESSION INDEX MOVE OF MORE THAN ABOUT 3%. '
 'THE MOVE WAS 1.21% ON THE DOW AND 0.45% ON THE S&P - WELL INSIDE IT. THE RULE WAS WRITTEN BEFORE THE EVENT AND IT IS '
 'HONOURED AFTER IT. || 💡 AND THE SECTOR DETAIL IS REASSURING FOR OUR THREE POWER NAMES. A HIKE SHOULD HURT UTILITIES '
 'AND THE S&P UTILITIES SECTOR FELL 1.2% - BUT CEG FELL ONLY 0.14%, GEV ROSE 4.79% AND VRT ROSE 2.05%. THE AI-POWER '
 'COMPLEX DECOUPLED FROM THE REGULATED-UTILITY COMPLEX ON A DAY THAT SHOULD HAVE HURT BOTH. ⚠️ ONE DAY IS NOT A TREND, '
 'BUT IT IS THE FIRST DIRECT TEST OF WHETHER THESE ARE RATE-SENSITIVE UTILITIES OR AI-DEMAND STOCKS, AND THEY TRADED '
 'AS THE SECOND. SEMIS HELD TOO - INTEL UP ABOUT 4.3-4.6% ON A REPORTED MEMORY PARTNERSHIP WITH SK HYNIX, BOTH OF '
 'WHICH WE HOLD - WHICH IS WHY THE NASDAQ WAS FLAT WHILE THE DOW LOST 600 POINTS. || 📋 THE SIX ORDER TICKETS, BUILT ON '
 'THE 16 SEPTEMBER CLOSES (verified against two independent sources) WITH THE LIMIT SET ONE PERCENT ABOVE EACH CLOSE. '
 'TSM: close 417.72, LIMIT 421.90, 35 SHARES, 14,766.50 plus commission. GEV: close 925.09, LIMIT 934.34, 8 SHARES, '
 '7,474.72. VRT: close 239.41, LIMIT 241.80, 26 SHARES, 6,286.80. PANW: close 375.65, LIMIT 379.41, 16 SHARES, '
 '6,070.56. CEG: close 259.53, LIMIT 262.13, 22 SHARES, 5,766.86. V: close 370.93, LIMIT 374.64, 13 SHARES, 4,870.32. '
 'TOTAL WITH ALL SIX COMMISSIONS: 45,287.12 IF EVERY ONE FILLS AT ITS CEILING, OR 44,839.09 IF EVERY ONE FILLS AT THE '
 '16 SEPTEMBER CLOSE. ⚠️ THAT IS 1,239.01 LESS THAN THE PLANNED 46,526.13 - THE DIFFERENCE IS WHOLE-SHARE ROUNDING AND '
 'IT SIMPLY STAYS IN CASH FOR THE NEXT RUNG. || ⚠️⚠️ AND A CORRECTION TO MY OWN ADVICE FROM LAST NIGHT. I TOLD SALEE A '
 'TWO-DAY SPLIT WOULD COST AN EXTRA 51.36. THAT IS ONLY TRUE IF EACH ORDER IS CUT IN HALF, MAKING TWELVE TRADES. IT '
 'DOES NOT HAVE TO BE DONE THAT WAY: SPLITTING BY STOCK - THREE COMPLETE ORDERS TONIGHT AND THREE ON MONDAY - IS STILL '
 'SIX TRADES AND STILL 51.36. IT COSTS NOTHING EXTRA. MY COST OBJECTION RESTED ON AN ASSUMPTION I NEVER STATED AND IT '
 'DOES NOT SURVIVE THE ARITHMETIC. || ✅ SO IF HE SPLITS: DAY ONE TONIGHT - TSM, V AND CEG, 25,429.36, THE THREE THAT '
 'DID NOT MOVE ON THE FED DAY. DAY TWO ON MONDAY 21 SEPTEMBER - GEV, VRT AND PANW, 19,857.76, THE THREE THAT DID. BUY '
 'WHAT DID NOT MOVE, WAIT ON WHAT JUMPED. ⚠️⚠️ AND THE HARD RULE: NOT FRIDAY 18 SEPTEMBER - TRIPLE WITCHING PLUS THE '
 'BANK OF JAPAN. MY RECOMMENDATION IS STILL SCENARIO ONE, ALL SIX TONIGHT, BUT THE MARGIN IS NOW THIN AND I SAY SO '
 'HONESTLY: NOW THAT THE SPLIT IS FREE, SCENARIO TWO IS PERFECTLY RESPECTABLE. THE ONLY WRONG ANSWER IS FRIDAY. || '
 '⚠️⚠️ THE PRACTICAL WARNING THAT MATTERS MOST: THESE ARE THE 16 SEPTEMBER CLOSES AND THE MARKET DOES NOT OPEN FOR '
 'ANOTHER FOURTEEN HOURS. FOLLOW THE RULE, NOT THE NUMBER: TAKE THE LAST TRADED PRICE IN POEMS, ADD ONE PERCENT, THAT '
 'IS THE LIMIT; DIVIDE THE DOLLAR AMOUNT BY IT AND ROUND DOWN TO A WHOLE SHARE. IF ANY NAME HAS MOVED MORE THAN ABOUT '
 '2% FROM THE CLOSE ABOVE, RECALCULATE RATHER THAN TYPING MY NUMBER - SETTING A LIMIT FROM A STALE PRICE IS EXACTLY '
 'THE ERROR I MADE ON CRM AND FN YESTERDAY. || 💡 THE LIMIT IS A CEILING, NOT A PRICE. SETTING TSM AT 421.90 DOES NOT '
 'MEAN PAYING 421.90 - IF TSM TRADES AT 417, YOU PAY ABOUT 417. A BUY LIMIT FILLS AT THE LIMIT OR BETTER, MEANING '
 'LOWER, AND CAN NEVER FILL WORSE. THERE IS NO PENALTY FOR SETTING IT A LITTLE HIGH; THERE IS A REAL ONE FOR SETTING '
 'IT TOO LOW, BECAUSE THE ORDER SIMPLY DOES NOT FILL. ALL SIX: BUY, LIMIT, GTC. NEVER MARKET, NEVER DAY. || PREVIOUS '
 "ENTRY: Sep 16, 2026 (8) - SALEE ASKED WHETHER TO SPLIT TOMORROW'S 46,526.13 ACROSS TWO OR THREE DAYS FOR TIME "
 'DIVERSIFICATION. ⚠️ ANSWER: NO - ALL SIX PROCEED ON 17 SEPTEMBER AS WRITTEN. CONVICTION HIGH. AND THE EXECUTION '
 'ADVICE BELOW MATTERS MORE THAN THE TIMING QUESTION. || ⚠️⚠️ REASON ONE, AND IT IS THE WHOLE ARGUMENT: IT IS NOT A '
 'LUMP SUM. THE 46,526.13 IS AN OUTPUT, NOT AN INPUT - NOBODY EVER DECIDED TO SPEND IT. SIX SEPARATE SIZING DECISIONS, '
 'TAKEN ON DIFFERENT DAYS FOR DIFFERENT REASONS, HAPPEN TO LAND ON ONE DATE. LOOK WHERE THEY GO: GEV ENDS AT EXACTLY '
 '10,000.00 INVESTED, VRT AT EXACTLY 10,000.00, CEG AT EXACTLY 10,000.00, PANW AT 9,999.47. THOSE ARE SIZING '
 'DECISIONS, NOT SPENDING DECISIONS, AND THE TOTAL IS JUST WHAT THEY ADD UP TO. || 💡 THE TIME DIVERSIFICATION HE WANTS '
 'IS ALREADY BUILT IN TWICE OVER. AT POSITION LEVEL, NOT ONE OF THE SIX REACHES ITS FULL BUDGET TOMORROW: TSM 74.2%, '
 'PANW 90.9%, GEV 76.9%, CEG 58.8%, V 55.6% (and that one OPENS the position), VRT 47.6% - every one keeps room for a '
 'later rung at a different price. AT BOARD LEVEL, THIS IS ONE OF THREE SCHEDULED DEPLOYMENT DAYS: 46,526.13 ON 17 '
 'SEPTEMBER, 42,419.52 ON 9 OCTOBER AND 35,913.27 ON 19 NOVEMBER. THE MONEY IS ALREADY SPREAD ACROSS NINE WEEKS. '
 'SPLITTING TOMORROW ADDS A THIRD LAYER ON TOP OF TWO THAT EXIST. || ⚠️ REASON TWO: THE BOARD ALREADY HAS A WRITTEN '
 'RULE ON EXACTLY THIS, AND KEEPING IT COST MORE LAST TIME. On 14 September, about VRT: A DOLLAR AMOUNT ON A DATE '
 "BEATS A PRICE WITH NO DATE. Then PANW ROSE 13.09% IN ONE SESSION AND THE BOARD REFUSED TO DELAY IT - 'A RULE THAT "
 "ONLY SURVIVES WHEN IT IS CONVENIENT IS NOT A RULE.' WE PAID ABOUT 790 DOLLARS TO KEEP IT TWO DAYS AGO. MOVING SIX "
 'DATES NOW, FOR A SOFTER REASON THAN THE ONE WE ALREADY REFUSED, WOULD RETIRE IT. || 📊 REASON THREE - THE ARITHMETIC. '
 'POEMS CHARGES A FLAT 8.56 PER TRADE. SIX TRADES IN ONE DAY COST 51.36, OR 0.110% OF THE MONEY. TWO DAYS MEANS TWELVE '
 'TRADES AT 102.72. THREE DAYS MEANS EIGHTEEN AT 154.08, OR 0.331%. THE THREE-DAY SPLIT COSTS AN EXTRA 102.72, CERTAIN '
 'AND PAID WHATEVER HAPPENS. ⚠️ AND WHAT IT BUYS IS A NARROWER RANGE OF ENTRY PRICES, NOT A BETTER ONE - SPREADING '
 'OVER THREE DAYS CUTS THE SPREAD OF POSSIBLE AVERAGE ENTRIES BY ROUGHLY FORTY-TWO PERCENT, BUT SYMMETRICALLY: IT '
 'REMOVES THE GOOD OUTCOMES EXACTLY AS MUCH AS THE BAD. THE EXPECTED PRICE IS UNCHANGED. Paying a certain fee to '
 'reduce uncertainty is only worth it if the uncertainty would make you do something foolish - AND FOR SOMEONE '
 'FOLLOWING A WRITTEN MULTI-RUNG PLAN IT WOULD NOT, BECAUSE THAT IS WHAT THE LATER RUNGS ARE FOR. || ⚠️⚠️⚠️ REASON '
 'FOUR, PRACTICAL AND DECISIVE: IF HE SPLITS INTO FRIDAY 18 SEPTEMBER HE BUYS ON TRIPLE WITCHING - the quarterly '
 'expiry, routinely the most erratic session of the quarter - AND ON THE SAME DAY AS THE BANK OF JAPAN. SPLITTING INTO '
 'THE 18TH WOULD INCREASE THE VERY RISK IT IS MEANT TO REDUCE. || ✅ THE ONE CONCESSION, IF THE EVENT CALENDAR '
 'GENUINELY WORRIES HIM: SPLIT ONLY TSM. At 15,000 it is 32.2% of the day and by far the largest single commitment. '
 'Half tomorrow, half on MONDAY 21 SEPTEMBER, SKIPPING TRIPLE WITCHING ENTIRELY. THAT COSTS ONE EXTRA 8.56 RATHER THAN '
 '102.72 AND ADDRESSES A THIRD OF THE EXPOSURE FOR EIGHT PERCENT OF THE COST. The other five go untouched. It is a '
 'concession to comfort, not an improvement to the plan. || ⚠️⚠️ AND THE PART THAT MATTERS MORE THAN THE TIMING '
 'QUESTION - HOW THE SIX ORDERS ARE PLACED. THIS MORNING WE LEARNED, THREE SESSIONS RUNNING, THAT A DAY ORDER WITH A '
 'LIMIT ON THE WRONG SIDE OF THE MARKET DIES AT THE CLOSE. THE BUY-SIDE RULE IS THE MIRROR IMAGE: FOR A SELL THE LIMIT '
 'GOES AT OR JUST BELOW THE LAST TRADE; FOR A BUY IT GOES AT OR JUST ABOVE IT. A BUY LIMIT ABOVE THE MARKET FILLS AT '
 'THE LIMIT OR BETTER - MEANING LOWER - AND CANNOT FILL WORSE. A BUY LIMIT BELOW THE MARKET IS NOT AN ENTRY, IT IS A '
 "WISH WITH A DEADLINE. ✅ SO, FOR ALL SIX TOMORROW, AND THEY ARE SALEE'S TO PLACE: (1) A LIMIT ON EVERY ONE, NEVER A "
 'MARKET ORDER. (2) THE LIMIT AT OR ONE OR TWO TICKS ABOVE THE LAST TRADE, NOT BELOW. (3) GTC RATHER THAN DAY, SO AN '
 'UNFILLED ORDER SURVIVES THE CLOSE. GETTING THOSE THREE RIGHT IS WORTH FAR MORE THAN ANY DAY-SPLITTING DECISION. || 💡 '
 'AND ONE REASSURANCE ON SIZE: AFTER TOMORROW, CASH FALLS FROM 236,324.23 TO 189,798.10 AND THE BOARD IS STILL ONLY '
 '61.96% DEPLOYED AGAINST ITS 1,000,000. NO LIQUIDITY STRAIN, NO ALL-IN MOMENT - 4.65% OF THE TOTAL PROGRAMME GOING TO '
 'WORK IN ONE SESSION ACROSS SIX COMPANIES IN FIVE GROUPS. || ⚠️ WHAT WOULD CHANGE MY MIND: A SINGLE-SESSION INDEX '
 'MOVE OF MORE THAN ABOUT 3% ON THE FED DECISION - WHICH IS A THESIS QUESTION, NOT A TIMING ONE, AND WOULD PAUSE '
 'EVERYTHING RATHER THAN STAGGER IT. AND WHAT WOULD NOT: ANY OF THE SIX SIMPLY OPENING HIGHER. WE ALREADY REFUSED THAT '
 'ARGUMENT ON PANW TWO DAYS AGO, AND A RULE ONLY WORKS IF IT WORKS BOTH TIMES. || PREVIOUS ENTRY: Sep 16, 2026 (7) - '
 'THE CUSTOM-ASIC VALUE CHAIN SLIDE. WE OWN SIXTEEN OF THE NINETEEN NAMES ON IT, IT CONTAINS NO ERRORS I COULD FIND, '
 'AND IT EXPOSED TWO REAL FAULTS ON OUR OWN BOARD - ONE OF THEM THE FIRST TRUE BUDGET BREACH THIS BOARD HAS EVER HAD. '
 '|| ⚠️⚠️ FAULT ONE: AMAZON HAS 48,600.75 INVESTED AGAINST A 48,000 BUDGET. OVER BY 600.75, OR 1.25%. IT IS THE ONLY '
 'NAME IN NINETY-FOUR WHERE MONEY SPENT EXCEEDS MONEY APPROVED, AND IT IS A WORSE CLASS OF FAULT THAN THE THREE FOUND '
 'EARLIER TODAY - THE MRVL 4,000, THE GOOGL 2,000 AND THE MICRON 11,000 WERE PROMISES, FIXABLE WITH A KEYSTROKE. THIS '
 'ONE IS ALREADY SPENT. The size looks like commission plus fill drift on the last tranche, but NO SOURCED CAUSE FOUND '
 'and I will not write a guess down as a cause. Amazon has no remaining schedule rows so the breach cannot widen. ⚠️ I '
 "HAVE DELIBERATELY NOT FIXED IT: raising Amazon's budget would break the hard constraint that all budgets sum to "
 'exactly 1,000,000 unless 600.75 is taken from another name, and quietly moving approved money to tidy a rounding '
 'error is how budgets stop meaning anything. SALEE DECIDES ON 10 DECEMBER - either raise Amazon and take it from an '
 'unspent budget, or write a TOLERANCE RULE of 2% or 1,000 whichever is smaller. I favour the tolerance rule. || ⚠️⚠️ '
 'FAULT TWO, AND IT IS THE FOURTH OF ITS KIND TODAY: SYNOPSYS HAS A 13,000 BUDGET, ZERO INVESTED, AND ZERO SCHEDULE '
 'ROWS - NOT ONE DATE, CONDITION OR TRIGGER. Five names carry a budget with nothing yet invested; four of them have '
 'rules. SYNOPSYS HAS NONE. APPROVED MONEY WITHOUT A WRITTEN CONDITION IS NOT A PLAN, IT IS A DRAWER. 💡 AND THE IRONY '
 "IS SHARP BECAUSE THE SLIDE PUTS SYNOPSYS IN THE LAYER EVERYTHING ELSE DEPENDS ON - ITS OWN CAPTION IS 'IDEAS INTO "
 "SILICON'. NOBODY DESIGNS A CUSTOM CHIP WITHOUT THE SOFTWARE SYNOPSYS AND CADENCE SELL, AND IT IS THE LAYER WE HAVE "
 'FUNDED LEAST: OF 513,000 OF BUDGET ACROSS THE SIXTEEN NAMES, THE WHOLE IP AND EDA LAYER HOLDS 3,918.01 OF ACTUAL '
 'INVESTMENT, ALL OF IT IN CADENCE, WHICH ITSELF HAS NO BUDGET. Decide on 10 December: write a plan, or cancel the '
 'budget. || ✅ THE MAP: 513,000 OF APPROVED BUDGET ACROSS THE SIXTEEN NAMES AGAINST 342,992.13 INVESTED - 170,007.87 '
 'STILL UNSPENT IN THIS ONE VALUE CHAIN. || 💡💡 AND HERE IS WHAT THE SLIDE DOES NOT SAY. READ ITS OWN FIRST BOX: THE '
 'REASONS GOOGLE, AMAZON, MICROSOFT AND META BUILD CUSTOM CHIPS ARE LISTED AS LOWER COSTS, BETTER EFFICIENCY, AND - '
 "PLAINLY - 'LESS RELIANCE ON THIRD-PARTY CHIPS'. THERE IS ONLY ONE THIRD PARTY THAT SENTENCE MEANS. THE ENTIRE "
 'CUSTOM-ASIC MOVEMENT IS AN ATTEMPT TO BUY LESS FROM NVIDIA - AND NVIDIA IS OUR LARGEST POSITION AT 79,380.28, 13.9% '
 'OF EVERYTHING INVESTED. || 💡 SO WHAT DO WE OWN? THE INCUMBENT BEING ATTACKED (NVDA). THE WEAPON BEING USED AGAINST '
 'IT (AVGO 30,125.18 AND MRVL 7,872.66). ALL FOUR ATTACKERS (GOOGL, AMZN, MSFT, META - 200,195.14 BETWEEN THEM). AND '
 'THE GROUND THEY FIGHT ON (TSMC MAKES EVERY ONE OF THESE CHIPS WHOEVER DESIGNS THEM; MICRON SELLS THE MEMORY BESIDE '
 'ALL OF THEM). ✅ THAT IS NOT A MUDDLE - IT IS THE CORRECT POSITION FOR SOMEONE WHO CANNOT PREDICT WHICH LAYER '
 'CAPTURES THE MARGIN, AND NOBODY CAN. || ⚠️⚠️ BUT THE ONE THING THIS SHAPE DOES NOT PROTECT AGAINST IS THE WHOLE '
 'CHAIN SPENDING LESS. IF AI CAPITAL EXPENDITURE FALLS, ALL SIXTEEN FALL TOGETHER - AND 342,992.13 OF OUR 573,060.10 '
 'SITS IN THIS SINGLE CHAIN. THAT IS SIXTY PERCENT OF EVERYTHING INVESTED, SHARING ONE DRIVER. THAT IS THE REAL '
 'CONCENTRATION RISK ON THIS BOARD, IT IS NOT NVIDIA-SPECIFIC, AND IT IS NOW A SINGLE LINE ON THE 10 DECEMBER AGENDA. '
 '|| ⚠️ THE THREE WE DO NOT OWN - ALCHIP, MEDIATEK AND SAMSUNG - ARE ALL LISTED IN TAIPEI OR SEOUL, SO THEY ARE '
 "OUTSIDE THE MANDATE RATHER THAN REJECTED ON MERIT. ⚠️ AND THE SLIDE'S FOOTER ABOUT CHINESE COMPETITORS FOLLOWS FROM "
 'NOTHING IN THE SIX BOXES AND CARRIES NO SOURCE - IGNORE IT. || ⚠️ HONEST NOTE ON MY OWN WORK: MY SWEEP ALSO FLAGGED '
 'INTEL AS OVER-SCHEDULED BY 3,216.96. THAT WAS MY ERROR - the 2,089.40 Intel row is a SELL, the partial sale executed '
 '9 September for a realised gain of 1,163.35, and my check counted a sale as a commitment. CORRECTED TO COUNT BUY '
 'TRANCHES ONLY. A test that cries wolf is worse than no test. || DECISION: NOTHING BOUGHT, NOTHING SOLD, NO BUDGET '
 'CHANGED. ⚠️ TOMORROW COMMITS 46,526.13 ACROSS SIX TRANCHES, ALL PROCEEDING AS WRITTEN. || PREVIOUS ENTRY: Sep 16, '
 '2026 (6) - THE 12-MONOPOLY SLIDE. WE OWN SIX OF THE TWELVE, NOTHING IN IT CHANGES A SINGLE LINE OF THE PLAN, AND IT '
 'STILL PRODUCED THE BEST NEW IDEA OF THE DAY - WHICH CAME OUT OF OUR OWN DATA, NOT OUT OF THE SLIDE. || ✅ OURS: ASML, '
 'TSM, NVDA, GOOGL, V AND ISRG - 329,000 OF BUDGET AGAINST 211,553.47 INVESTED, LEAVING 117,446.53 APPROVED AND '
 ...
 'optics, sold once to a customer who will not need another for years. VISA SELLS PERMISSION TO USE A NETWORK - the '
 'ten-millionth transaction costs almost nothing more than the first. ASML IS LIKE OWNING THE ONLY OVEN FACTORY IN THE '
 'WORLD; VISA IS LIKE TAKING A CUT OF EVERY SANDWICH SOLD EVERYWHERE, FOR EVER. BOTH ARE MONOPOLIES. ONLY ONE GETS '
 'PAID AGAIN TOMORROW WITHOUT DOING ANYTHING. || ⚠️⚠️ AND THE SECOND HALF POINTS AT TWO OF OUR OWN HOLDINGS, SO IT IS '
 'NOT ACADEMIC: CROWDSTRIKE HAS A 75.14% GROSS MARGIN AND A 0.83% NET MARGIN, RETURN ON EQUITY 0.74%. PALO ALTO HAS '
 '70.36% GROSS AND 2.67% NET, RETURN ON EQUITY 1.12%. BOTH HAVE REAL MOATS AND BOTH SPEND ESSENTIALLY THE WHOLE MOAT '
 'BEFORE IT REACHES THE OWNER. NVIDIA HAS THE SAME GROSS MARGIN AS CROWDSTRIKE - 75.00% - AND SEVENTY-SIX TIMES THE '
 'NET MARGIN AT 63.66%, WITH A 117.21% RETURN ON EQUITY. 💡 THE RULE: GROSS MARGIN TELLS YOU THERE IS A MOAT. NET '
 'MARGIN AND RETURN ON EQUITY TELL YOU WHETHER THE OWNER KEEPS WHAT THE MOAT COLLECTS. READ THEM AS A PAIR, NEVER '
 "ALONE. || 💡 ONE PROOF THE SLIDE DOES NOT KNOW IT HAS: ITS 'STANDARD MONOPOLY' CATEGORY IS S&P GLOBAL AND MOODY'S, "
 'AND THIS BOARD ALREADY PROVES THAT MOAT FROM THE INSIDE - OUR WHOLE ORACLE CREDIT ARGUMENT RESTS ON S&P CUTTING ORCL '
 "TO BBB- ON 9 JULY AND MOODY'S HOLDING Baa2 NEGATIVE, AND WE TREAT BOTH AS AUTHORITATIVE WITHOUT EVER ASKING WHO ELSE "
 'WE COULD ASK. WE ARE UNPAID EVIDENCE FOR THEIR BUSINESS MODEL. || ⚠️ THE SIX WE DO NOT OWN - MASTERCARD, CME, S&P '
 "GLOBAL, MOODY'S, FICO AND VERISIGN - HAVE NEVER BEEN SCREENED HERE. A SEARCH OF EVERY SCHEDULE ENTRY AND THE WHOLE "
 'DASHBOARD HISTORY RETURNS ZERO MENTIONS OF ANY OF THEM AS CANDIDATES. THOSE ARE ABSENCES, NOT REJECTIONS, AND I WILL '
 'NOT DRESS THEM UP AS DECISIONS. The reason they are absent is the mandate: PILLAR 4 EXISTS TO DOUBLE IN FIVE YEARS, '
 'ABOUT 14.9% A YEAR COMPOUNDED, AND THE BOARD WAS BUILT AROUND AI AND GROWTH TO GET THERE. WHETHER IT SHOULD ALSO '
 'HOLD SOME SLOW, UNKILLABLE TOLL BOOTHS AS BALLAST AGAINST THE AI CONCENTRATION IS A REAL QUESTION - AND A MANDATE '
 "QUESTION FOR 10 DECEMBER, NOT A SLIDE QUESTION FOR TODAY. || ⚠️ NO 'MOAT' COLUMN WILL BE ADDED TO THIS BOARD. A moat "
 'type is an OPINION and the rule here is SOURCED OR BLANK; six labels across ninety-four names would be ninety-four '
 'judgments dressed as data. ✅ INSTEAD, A BOARD-WIDE RANKING ON THE FOUR PROXIES WE ALREADY HOLD - GROSS MARGIN, NET '
 'MARGIN, RETURN ON EQUITY AND FREE CASH FLOW OVER REVENUE, READ TOGETHER - IS NOW ON THE 10 DECEMBER AGENDA. '
 'ARITHMETIC RATHER THAN ADJECTIVES. || DECISION: NOTHING BOUGHT, NOTHING SOLD, NO BUDGET ALTERED, NO NEW NAME ADDED. '
 '⚠️ AND TOMORROW STILL COMMITS 46,526.13 ACROSS SIX TRANCHES - CEG 5,959.02, GEV 7,852.70, PANW 6,238.85, TSM 15,000, '
 'V 5,000 AND VRT 6,475.56 - ALL PROCEEDING AS WRITTEN. || PREVIOUS ENTRY: Sep 16, 2026 (5) - THE 15-THEME LIST, AND '
 'IT IS THE CLOSEST ANY SLIDE HAS COME TO THIS BOARD: WE ALREADY OWN OR CARRY TWELVE OF THE FIFTEEN. ⚠️⚠️ AND THOSE '
 'TWELVE HOLD 156,687.44 OF APPROVED BUDGET WE HAVE NOT SPENT - 416,000 APPROVED AGAINST 259,312.56 INVESTED. THE '
 'SLIDE IS NOT ASKING US TO FIND ANYTHING. IT IS ASKING US TO FINISH WHAT WE STARTED. || OURS, FUNDED: TSM, NVDA, '
 'AVGO, MU, ASML, MSFT, CEG, VST AND RKLB. HELD WITH NO BUDGET: CRWD. ON THE BOARD BUT DELIBERATELY UNFUNDED: IONQ AND '
 "OKLO. NOT OURS: ROK AND ENPH - and SOFI, WHICH WE SOLD ON 16 JULY AT A REALISED LOSS OF 152.40. TWO OF TOMORROW'S "
 'SIX TRANCHES, CEG AND TSM, ARE ON THIS VERY LIST. || ⚠️ THE TWO WE REFUSE TO FUND ARE REFUSALS, NOT OVERSIGHTS. IONQ '
 'TRADES AT 73 TIMES SALES AND ⚠️ ITS OWN FIELDS CONTRADICT EACH OTHER - A NET MARGIN OF 174.88% AND A P/E OF 33.57 '
 'AGAINST ITS OWN PRICE-DIVIDED-BY-EARNINGS OF 40.27. OKLO IS A 6.693 BILLION DOLLAR COMPANY ON 1.21 MILLION DOLLARS '
 'OF REVENUE - 5,531 TIMES SALES - AND ⚠️⚠️ IT CLOSED ON 15 SEPTEMBER AT 35.98, WHICH IS EXACTLY ITS FIFTY-TWO WEEK '
 'LOW AND 78.0% BELOW ITS ALL-TIME HIGH. A LIST RECOMMENDING IT WITHOUT SAYING SO IS NOT A LIST, IT IS A WISH. Our '
 'nuclear and power answer is CEG and VST, both of which earn money today. || ⚠️ CROWDSTRIKE IS THE ODD ONE OUT AMONG '
 'THE NAMES WE DO HOLD: 40 SHARES, NO BUDGET, AND A FORWARD P/E OF 146.57 - BY A WIDE MARGIN THE MOST EXPENSIVE NUMBER '
 'ON THE LIST - ON A 0.83% NET MARGIN. The written rule stands: back-up, zero budget, do not sell by habit and do not '
 'buy without the trigger. || ⚠️⚠️⚠️ AND A SYSTEMATIC DATA FAULT WAS FOUND WHILE DOING THIS, WHICH IS WORTH MORE THAN '
 'THE SLIDE. A ROUTINE CHECK - IS ANY PRICE ABOVE ITS OWN RECORDED ALL-TIME HIGH - RETURNED SIX NAMES: DELL 543.51 '
 'AGAINST A RECORDED 490.81 (10.74% TOO LOW), CROWDSTRIKE 242.49 AGAINST 225.53, ZETA 31.04 AGAINST 29.62, CLOUDFLARE '
 '327.23 AGAINST 315.78, VISA 375.62 AGAINST 364.15 AND FORTINET 172.37 AGAINST 170.35. ALL SIX ARE NOW RAISED TO THE '
 '15 SEPTEMBER CLOSE. THE DIAGNOSIS IS EXACT: THE DAILY REFRESH EXTENDS hi52 AND lo52 AND NEVER TOUCHES ath - ZERO '
 'TICKERS HAD A PRICE ABOVE hi52, SIX HAD A PRICE ABOVE ath. ⚠️ IT WILL COME BACK TOMORROW UNLESS THE ROUTINE IS '
 'CHANGED TO SET ath = max(ath, close) ON EVERY RUN. THAT IS THE SECOND DEFECT FOUND IN THE SAME DAILY ROUTINE TODAY - '
 'THE FIRST SILENTLY DELETED 362,000 CHARACTERS OF HISTORY THIS MORNING. THE ROUTINE IS NOW THE LARGEST SINGLE SOURCE '
 'OF DATA FAULTS ON THIS BOARD AND NEEDS A LINE-BY-LINE REVIEW, NOT ANOTHER PATCH. || ⚠️ A SECOND CHECK - ANY NET '
 'MARGIN OUTSIDE PLUS OR MINUS 100% - RETURNED THREE: IONQ AT 174.88%, ONDS AT 251.92% AND LITE AT MINUS 230.10%. THE '
 'FIRST TWO ARE UNFUNDED SO NO MONEY IS AT RISK. ⚠️ LITE IS FUNDED - 9,372.74 INVESTED WITH 4,627.26 OF APPROVED ROOM '
 '- AND THAT ROOM STAYS FROZEN UNTIL THE 10-Q RESOLVES IT. || 📌 THE LESSON IS BIGGER THAN THE NUMBERS: AN '
 'INTERNAL-CONSISTENCY CHECK COSTS NOTHING AND CATCHES WHAT EYES DO NOT. PRICE CANNOT EXCEED THE ALL-TIME HIGH. '
 'INVESTED CANNOT EXCEED BUDGET - that caught the MRVL 4,000 and the GOOGL 2,000. SCHEDULE AMOUNTS MUST SUM TO '
 'REMAINING BUDGET. A NET MARGIN CANNOT PLAUSIBLY EXCEED 100%. RUN ALL FOUR ON EVERY REFRESH. || DECISION: NOTHING '
 'BOUGHT, NOTHING SOLD, NO BUDGET CHANGED. ⚠️ AND TOMORROW STILL COMMITS 46,526.13 ACROSS SIX TRANCHES, ALL PROCEEDING '
 "AS WRITTEN. || PREVIOUS ENTRY: Sep 16, 2026 (4) - THE HUMANOID QUESTION, ANSWERED NO. ⚠️ MUSK'S QUOTE IS REAL, THE "
 "ARITHMETIC BEHIND IT IS NOT, AND THE 'XPENG ROBOT FACTORY' SLIDE IS WRONG ON THE COMPANY AND MISLEADING ON THE "
 'NUMBER. NOTHING BOUGHT, NOTHING SOLD, NO BUDGET RAISED. || ✅ THE QUOTE IS GENUINE: G20 INNOVATION MINISTERIAL, 1 '
 "SEPTEMBER 2026 - 'Ten years from now, I would say there are well over a billion humanoid robots.' IT IS A CUMULATIVE "
 'INSTALLED BASE BY ABOUT 2036. ⚠️ BUT MUSK HAS GIVEN AT LEAST SIX VERSIONS SPANNING A TWENTY-FOLD RANGE - 1 BILLION '
 "CUMULATIVE IN THE 2040s, 1 BILLION A YEAR, 10 BILLION BY 2040, AND 'PROBABLY 20 OR MORE' - TWO OF THEM IN THE SAME "
 'SITTING ON 13 JUNE 2024. || 📊 THE ARITHMETIC NOBODY DID: ONE BILLION OVER TEN YEARS IS ONE HUNDRED MILLION UNITS A '
 'YEAR. GLOBAL MOTOR VEHICLE PRODUCTION IN 2025 WAS 96.4 MILLION (OICA). THE CLAIM REQUIRES BUILDING MORE HUMANOIDS '
 'EACH YEAR THAN THE WORLD BUILDS CARS, FROM A STANDING START. THE ENTIRE GLOBAL INSTALLED BASE OF INDUSTRIAL ROBOTS, '
 'AFTER SIXTY YEARS, IS 4,664,000 UNITS (IFR) - ONE BILLION IS 214 TIMES THAT. AND MORGAN STANLEY, THE MOST BULLISH '
 'MAINSTREAM HOUSE, REACHES ONE BILLION CUMULATIVE IN 2050, NOT 2036 - FOURTEEN YEARS BEHIND HIM. INTERACT ANALYSIS '
 'FORECASTS 700,000 UNITS A YEAR IN 2035, WHICH IS 0.7% OF THE REQUIRED RUN-RATE. || ⚠️⚠️ THE DECIDING EVIDENCE IS THE '
 "TRACK RECORD. APRIL 2019: 'over a million robotaxis on the road' BY 2020. TEXAS DMV DATA ON 2 JUNE 2026: FORTY-TWO "
 'REGISTERED. A MISS OF ABOUT TWENTY-FOUR THOUSAND TIMES. CYBERTRUCK: 250,000 A YEAR PROMISED, 17,012 DELIVERED IN '
 '2025 - 93% SHORT, WITH SPACEX BUYING 1,279 OF THEM. TESLA SEMI: PRODUCTION PROMISED 2019, SERIAL PRODUCTION BEGAN 29 '
 "APRIL 2026 - SEVEN YEARS LATE. ROADSTER: PROMISED 2020, STILL NOT PRODUCED NINE YEARS ON. FSD HAS BEEN 'later this "
 "year' FOR TEN STRAIGHT YEARS. AND OPTIMUS: 10,000 PLANNED FOR 2025, ACTUAL 'ONLY IN THE HUNDREDS'. NO "
 "COUNTER-EXAMPLE WAS FOUND WHERE A MUSK VOLUME FORECAST WAS MET ON THE STATED DATE. ⚠️ TESLA'S Q2 2026 10-Q DOES NOT "
 "CONTAIN THE WORD 'OPTIMUS' AT ALL, AND MUSK HIMSELF SAID ON THE Q1 CALL: 'I DON'T KNOW WHAT THE PRODUCTION RATE OF "
 "OPTIMUS WILL BE THIS YEAR. IT IS IMPOSSIBLE TO PREDICT THESE THINGS.' || ⚠️⚠️ THE SECOND SLIDE IS WRONG TWICE. THE "
 "FACTORY IS NOT XPENG'S - IT IS UBTECH AT LIUZHOU, COMMISSIONED 12 SEPTEMBER. XPeng opened a SEPARATE line on 7-8 "
 "September and claimed no rate at all; He Xiaopeng said 'Today's step is small.' AND 'ONE EVERY 10 MINUTES' IS A "
 "DESIGN TAKT - the Chinese original says '按照产线设计节拍', according to the line's DESIGN takt - NOT A MEASURED OUTPUT. 📊📊 "
 "AND THE NUMBER THAT ENDS THE EXCITEMENT: BMW'S SPARTANBURG PLANT BUILDS MORE THAN 1,500 VEHICLES A DAY - ONE CAR "
 "EVERY 48 TO 57 SECONDS, ACTUAL. 'ONE EVERY 10 MINUTES' IS TEN TO TWELVE TIMES SLOWER THAN A NORMAL CAR PLANT, AND A "
 "CAR IS FAR MORE COMPLEX. UBTECH'S OWN DEMONSTRATED RATE IS 921 UNITS IN SIX MONTHS - ABOUT ONE EVERY 4.8 HOURS, "
 'TWENTY-NINE TIMES SLOWER THAN THE TAKT IT JUST ADVERTISED. || ✅ THE BULL CASE IS REAL THOUGH: OVER 22,000 HUMANOIDS '
 'SHIPPED GLOBALLY IN H1 2026, UP ABOUT 300%. UBTECH DISCLOSED RMB 590.3m OF HUMANOID REVENUE, UP 1,445%. AND UNITREE, '
 'WHICH LISTED IN SHANGHAI ON 19 AUGUST AND ROSE 460% ON DEBUT, IS ACTUALLY PROFITABLE - RMB 278.21m OF NET PROFIT ON '
 'RMB 1.70bn OF 2025 REVENUE. THIS IS NO LONGER A POWERPOINT INDUSTRY. || ⚠️⚠️ SO WHY NO: BECAUSE WE CANNOT BUY IT. '
 'FOUR OF THE TOP FIVE SHIPPERS ARE CHINESE AND TESLA DOES NOT APPEAR IN THE RANKING. THE TWO COMPANIES ON EARTH WITH '
 'DISCLOSED HUMANOID REVENUE ARE LISTED IN HONG KONG AND SHANGHAI. AND THE FINDING THAT MATTERS MOST: NOT ONE LISTED '
 "COMPONENT SUPPLIER SEPARATELY DISCLOSES HUMANOID REVENUE IN ITS FILINGS - HARMONIC DRIVE BURIES IT IN 'INDUSTRIAL "
 "ROBOTS', THK CREDITS 'LINEAR-MOTION DEMAND', AND SANHUA 'DID NOT BREAK OUT REVENUE'. EVERY SUPPLY-CHAIN HUMANOID "
 'NUMBER IN CIRCULATION IS AN ANALYST CONSTRUCTION. YOU CANNOT UNDERWRITE WHAT NOBODY REPORTS. || 💡💡 THE REFRAME: THE '
 "QUESTION 'SHOULD WE BUY HUMANOIDS' HAS THE WRONG SHAPE. THE RIGHT QUESTION IS WHAT WE ALREADY OWN THAT GETS PAID "
 'WHETHER OR NOT HUMANOIDS WORK. NVIDIA SELLS THE BRAINS. COGNEX SELLS THE EYES - AND HAS 7,932.38 OF APPROVED ROOM '
 'UNUSED. TERADYNE TESTS THE CHIPS. INTUITIVE SURGICAL IS THE ONLY GENUINELY PROFITABLE ROBOT COMPANY ON THIS BOARD. '
 '⚠️ GROUP 7 HOLDS 23,550.70 OF APPROVED BUDGET UNSPENT - THE SIXTH SLIDE IN THREE WEEKS POINTING AT SOMETHING WE DO '
 "NOT OWN WHILE APPROVED MONEY SITS IDLE. || ⚠️ RODNEY BROOKS, 26 SEPTEMBER 2025: 'we are more than ten years away "
 "from the first PROFITABLE deployment of humanoid robots even with minimal dexterity.' KEN GOLDBERG OF BERKELEY: "
 "'being able to pick up a wine glass or change a light bulb. NO ROBOT CAN DO THAT.' REUTERS REPORTS ROBOTS RUNNING AT "
 'ABOUT 20% OF HUMAN OUTPUT, AND ONLY ABOUT 10% OF HUMANOIDS BUILT IN 2025 WERE EVER DEPLOYED. AND PRICES ARE ALREADY '
 'FALLING BEFORE VOLUME ARRIVES - MORGAN STANLEY SEES A 15% AVERAGE PRICE DECLINE IN 2026. || ✅ WRITTEN RE-UNDERWRITE '
 'TEST, BOTH MUST HOLD: (1) A US-LISTED COMPANY DISCLOSES HUMANOID REVENUE AS A SEPARATE LINE IN A 10-Q OR 10-K - A '
 'FILING, NOT AN ESTIMATE; AND (2) THAT LINE EXCEEDS 100 MILLION DOLLARS ANNUALISED WITH A POSITIVE GROSS MARGIN. '
 'CONVICTION HIGH. ⚠️ AND TOMORROW STILL COMMITS 46,526.13 ACROSS SIX TRANCHES, ALL PROCEEDING AS WRITTEN. || PREVIOUS '
 'ENTRY: Sep 16, 2026 (3) - THE SUPERCYCLE SLIDE, AND FOR ONCE THE HEADLINE NUMBER IS RIGHT. ⚠️ BUT IT IS AN ESTIMATE '
 'REVISED UPWARD FOUR TIMES IN NINE MONTHS, THE PRICE MOMENTUM BEHIND IT HAS ALREADY DECELERATED BY FIVE SIXTHS, AND '
 'EVERY NEW FAB IN THE WORLD LANDS IN 2027. THE RESEARCH DID CLOSE AN OPEN FAULT ON OUR OWN BOARD, WHICH IS THE BEST '
 "THING A SLIDE HAS DONE IN A FORTNIGHT. || ✅ VERIFIED: WSTS's Q2 2026 release says the 2026 market reaches 1,655 "
 'BILLION DOLLARS, up about 108%, and DigiTimes Intelligence independently lands on 1.6 TRILLION on 15 September. 2025 '
 'ACTUAL was 791.7bn. ⚠️ BUT THE SAME BODY FORECAST 975 BILLION FOR 2026 ON 2 DECEMBER 2025, THEN 1.51 TRILLION ON 2 '
 'JUNE, THEN 1,655 BILLION. A NUMBER THAT HAS MOVED 70% IN NINE MONTHS IS NOT A FOUNDATION. AND SEVEN MONTHS OF 2026 '
 "ARE ACTUAL WHILE FIVE ARE STILL PROJECTED. ⚠️ NOTE ALSO THAT NEITHER WSTS NOR SIA USES THE WORD 'SUPERCYCLE' - IT "
 "COMES FROM A BANK OF AMERICA NOTE, QUOTED BACK BY SK HYNIX'S OWN NEWSROOM, WHOSE JANUARY FORECASTS OF DRAM PLUS 51% "
 'WERE THEMSELVES BLOWN THROUGH. THE FORECASTING ERROR RUNS BOTH WAYS. || ✅ THE BOOM ITSELF IS REAL AND IT IS IN '
 'AUDITED FILINGS, NOT FORECASTS: Micron fiscal Q3 revenue 41,456m with an 84.6% GAAP GROSS MARGIN and 28,243m of net '
 "income; SK hynix Q2 revenue up 257% at a 76% OPERATING MARGIN; AND SAMSUNG'S CHIP DIVISION EARNED 89.2 OF THE "
 "GROUP'S 89.5 TRILLION WON OF OPERATING PROFIT - 99.7% OF SAMSUNG'S PROFIT NOW COMES FROM CHIPS. || 📊 THE NUMBER THE "
 'SLIDE OMITS, AND IT IS THE ONLY ONE THIS BOARD WILL TRACK FROM NOW ON - CONVENTIONAL DRAM CONTRACT PRICES QUARTER ON '
 'QUARTER: 1Q26 UP TO PLUS 98%, 2Q26 PLUS 58 TO 63%, 3Q26 PLUS 13 TO 18%. PRICES ARE STILL RISING BUT THE RATE HAS '
 "FALLEN BY ROUGHLY FIVE SIXTHS IN TWO QUARTERS, AND TRENDFORCE SAYS RECORD PRICES HAVE REACHED CUSTOMERS' "
 "'AFFORDABILITY LIMIT'. THE MARKET SIZE IS A LAGGING NUMBER. THE CONTRACT PRICE IS A LEADING ONE. || ⚠️⚠️ AND THE "
 "SUPPLY ANSWER IS ALREADY FUNDED AND DATED: SAMSUNG'S PYEONGTAEK P5, PULLED FORWARD SIX MONTHS, ADDS ABOUT 600,000 "
 "WAFERS A MONTH AGAINST SAMSUNG'S CURRENT ENTIRE DRAM CAPACITY OF 650,000 - ROUGHLY A DOUBLING, IN 2027. SK HYNIX "
 "PULLED ITS FIRST YONGIN CLEANROOM FORWARD TO FEBRUARY 2027. MICRON'S IDAHO ARRIVES MID-2027. TRENDFORCE ALREADY "
 'FORECASTS NAND SUPPLY OUTPACING DEMAND FROM THE SECOND HALF OF 2027. AND THE OLIGOPOLY IS LOOSENING: CXMT REACHED '
 '10% OF DRAM IN Q2, FOURTH PLACE, AND YMTC BROKE THE NAND TOP THREE ON BITS. || ⚠️ THE HISTORY, FROM SIA AND WSTS: '
 'MEMORY REVENUE FELL 32.6% IN 2019 AND ABOUT 29% IN 2023, EACH IN ONE YEAR, WITH DRAM ALONE DOWN 37.1% IN 2019. THE '
 'FORTY-YEAR RULE IS THAT MEMORY GROWTH ABOVE 50% IS FOLLOWED BY DECELERATION OR DECLINE - TRUE FOUR TIMES IN SIX. '
 '2026 IS FORECAST AT PLUS 302%, SIX TIMES THE THRESHOLD. || 💡💡 SO THE REAL QUESTION IS NOT THE 1.6 TRILLION, IT IS '
 "THAT THE TWO BEST-SOURCED VOICES DISAGREE FLATLY ABOUT 2027. SK HYNIX'S CEO KWAK NOH-JUNG, 11 JULY 2026: 'We "
 "forecast that next year will be the worst year in the industry's history from the supply perspective' and demand "
 "exceeds supply 'even beyond 2030'. AGAINST THAT, TRENDFORCE SAYS NAND FLIPS TO SURPLUS IN 2H27, AND MORGAN STANLEY "
 "WROTE ON 10 AUGUST THAT 'room for further upward earnings revisions could narrow starting in the fourth quarter'. || "
 '⚠️⚠️ AND THE TRAP ON OUR OWN BOARD, WRITTEN PLAINLY BECAUSE IT IS THE MOST IMPORTANT THING HERE: MICRON TRADES AT '
 '21.5 TIMES TRAILING EARNINGS AND 6.63 TIMES FORWARD EARNINGS. A FORWARD MULTIPLE OF 6.6 IS THE CHEAPEST NUMBER ON A '
 'BOARD OF 94 NAMES. IT IS ALSO THE MOST DANGEROUS. A MEMORY COMPANY LOOKS CHEAPEST AT THE TOP OF ITS CYCLE, BECAUSE '
 "THE EARNINGS IN THE DENOMINATOR ARE PEAK EARNINGS AND EVERYONE IS EXTRAPOLATING THEM. MICRON'S EARNINGS PER SHARE "
 'GREW 695.9%. THAT IS A PEAK UNTIL PROVEN OTHERWISE. || ✅✅ THE ONE CONCRETE GAIN: THE OPEN MICRON 11,000 FAULT IS '
 'CLOSED. The written plan described a 40,000 budget while the board carried 51,000, leaving 11,000 with no rule. IT '
 "NOW HAS ONE, AND IT IS A CONDITION RATHER THAN A DATE: RELEASED ONLY IF MICRON'S 30 SEPTEMBER PRINT DELIVERS A GROSS "
 'MARGIN AT OR ABOVE THE GUIDED 86% AND FOURTH-QUARTER DRAM CONTRACT PRICES ARE STILL RISING - AND CANCELLED, NOT '
 'DEFERRED, IF CONTRACT PRICES GO FLAT OR NEGATIVE IN ANY QUARTER. A parked amount with no cancellation condition is '
 'not a plan, it is a drawer. || DECISION: NOTHING BOUGHT, NOTHING SOLD, NO BUDGET RAISED. Memory is already 24,494.84 '
 'invested across MU and SKHY with 26,505.16 of Group 3 budget unspent. WE DO NOT NEED MORE MEMORY ON A HEADLINE. ⚠️ '
 'AND THE 30 SEPTEMBER MICRON PRINT IS NOW THE SINGLE MOST IMPORTANT DATE ON THIS BOARD: READ THE GROSS MARGIN AND THE '
 'NEXT-QUARTER GUIDE FIRST, NOT THE REVENUE LINE. || PREVIOUS ENTRY: Sep 16, 2026 (2) - TWO SLIDES CHECKED, AND THEY '
 'LAND IN OPPOSITE PLACES: THE PROBE CARD SLIDE IS PART-INVENTED, THE WAYMO SLIDE IS ALMOST ENTIRELY TRUE AND STILL '
 'DOES NOT MATTER YET. ⚠️ AND A THIRD GOOGL DATA FAULT WAS FOUND WHILE CHECKING - THE 19 NOVEMBER TRANCHE PROMISED '
 "2,000 MORE THAN THE BUDGET HOLDS. || ⚠️⚠️ SLIDE 1 - 'TSMC AND NVIDIA PAY A PREMIUM FOR PROBE CARDS; BUY FORMFACTOR'. "
 "THE CUSTOMER CLAIM IS EXACTLY RIGHT: FormFactor's 10-Q for the quarter ended 27 June 2026 names SK HYNIX AT 24.3% "
 'AND TSMC AT 11.0% OF REVENUE. THE TIGHTNESS IS REAL TOO: MPI probe card lead times ran to SIX MONTHS with two-year '
 'visibility, MPI weighed prepayments for priority, and Technoprobe is spending about 200m euro to double capacity. '
 "BUT THE PREMIUM CLAIM RESTS ON ONE ANONYMOUS PAYWALLED PARAGRAPH - DigiTimes, 10 September 2026, 'supply-chain "
 "sources say Nvidia has raised prices' - WITH NO FILING, NO NAMED EXECUTIVE AND NO SECOND OUTLET. ⚠️⚠️ AND TSMC IS "
 "NOT IN THAT REPORT AT ALL. IT NAMES NVIDIA ONLY. TSMC WAS ADDED BY WHOEVER MADE THE SLIDE. TSMC'S OWN CEO POINTED "
 "SOMEWHERE ELSE ENTIRELY ON 16 JULY: 'Our packaging capacity is so tight that now it limits my customers' growth' - "
 'PACKAGING, NOT TESTING. || ⚠️ AND THE TRADE FAILS EVEN IF THE PREMIUM IS REAL: NVIDIA IS NOT A DISCLOSED 10% '
 'CUSTOMER OF FORMFACTOR. The vendors actually named in the reporting are TAIWANESE - MPI, Chunghwa Precision Test, '
 'WinWay - none on this board. DECISION: FORMFACTOR NOT BOUGHT. The company is genuinely good - Q2 revenue 258.2m UP '
 '31.9%, 21.8% net margin, 136.1m of trailing free cash flow, NET CASH OF 334m, stock compensation only 4.0% of '
 'revenue, and a Rule of 40 of 47.0 that passes - BUT AT 68.8 TIMES EARNINGS AND A 1.71% FREE-CASH-FLOW YIELD IT SITS '
 'BELOW THE 1.94% MEDIAN THIS BOARD ALREADY CALLED A FAILURE, AFTER RISING 237% IN A YEAR. ⚠️⚠️ AND THE REAL REASON IS '
 'CLOSER TO HOME: WE ALREADY OWN THE TEST THEME THREE WAYS - TERADYNE, KLA AND TSMC ITSELF - AND GROUP 2 IS SITTING ON '
 '88,292.04 OF APPROVED BUDGET IT HAS NOT SPENT. THIS IS THE FIFTH SLIDE IN TWO WEEKS POINTING AT A NAME WE DO NOT OWN '
 'WHILE APPROVED MONEY GOES UNDEPLOYED IN THE VERY GROUP IT WOULD JOIN. WRITTEN RE-UNDERWRITE TEST: A 3% '
 'FREE-CASH-FLOW YIELD (about 58 dollars a share, or trailing free cash flow above 238m) AND EITHER NVIDIA NAMED AS A '
 '10% CUSTOMER IN A 10-Q OR A FILING CONFIRMING PRICE INCREASES. || 💡 SLIDE 2 - WAYMO IN TOKYO. THIS ONE IS REAL AND '
 "TWO DAYS OLD: Waymo's blog 14 September, Nihon Kotsu and GO 15 September. Tokyo, Level 4, NO SAFETY DRIVER, targeted "
 '2027, hailed through the GO app, testing since 2025 - ALL CONFIRMED. Two corrections only: the ~100 vehicles is '
 "WHERE THE FLEET EXPANDS TO IN PHASES, not where it starts; and 'Alphabet proves it can scale outside the USA' IS NOT "
 "TRUE YET - ALL FOURTEEN OF WAYMO'S COMMERCIAL CITIES ARE AMERICAN, and the first driverless commercial permit "
 'outside the US went to WERIDE IN ABU DHABI, not Waymo. || ⚠️⚠️ AND THE INVESTOR ANSWER, WHICH THE SLIDE DOES NOT '
 "GIVE: ALPHABET DOES NOT DISCLOSE WAYMO'S REVENUE AT ALL. Waymo sits inside 'Other Bets', WHICH IS BIGGER THAN WAYMO, "
 "AND OTHER BETS EARNED 382 MILLION IN Q2 2026 AGAINST ALPHABET'S 119,796 MILLION - 0.32%, ONE THIRD OF ONE PERCENT - "
 "WHILE LOSING 1,799m, A 4.41% DRAG ON OPERATING INCOME. 📊 AND THE SIZE TEST: Waymo's February round valued it at "
 '126bn. ALPHABET IS WORTH 4,223bn. EVEN AT 100% OWNERSHIP WAYMO WOULD BE 2.98% OF ALPHABET. IT IS A REAL OPTION, NOT '
 'A SECOND ENGINE, AND IT IS NOT WHY WE OWN THE SHARES. The operating progress is impressive anyway - OVER 500,000 '
 'PAID TRIPS A WEEK, DOUBLED IN A YEAR, 14 CITIES, 4,000+ VEHICLES, 220.6M RIDER-ONLY MILES - and so are the risks: '
 "THE NTSB'S FIRST-EVER WAYMO INVESTIGATION after a driverless car STRUCK A NINE-YEAR-OLD IN A SANTA MONICA SCHOOL "
 'ZONE ON 23 JANUARY 2026, a 3,000-vehicle software recall in December 2025, the 4 July San Francisco gridlock, and '
 "San Diego's council voting unanimously against Waymo's autonomy on 14 September. DECISION: NOTHING CHANGES ON GOOGL. "
 '|| ⚠️⚠️ THE GOOGL FAULT, AND IT IS THE SECOND OF ITS EXACT KIND IN SIX DAYS: THE 19 NOVEMBER TRANCHE 3 ROW SAID '
 '20,524.08. THE BUDGET IS 78,000 WITH 59,475.92 INVESTED, SO ONLY 18,524.08 REMAINS - THE ROW WAS PROMISING 2,000 '
 'THAT DOES NOT EXIST. CORRECTED TO 18,524.08, WHICH NOW CLOSES THE BUDGET EXACTLY. The MRVL row had the same disease '
 'on 11 September (17,127.34 against a true 13,127.34). TWO OF ONE KIND IS A PROCESS PROBLEM, NOT BAD LUCK: A SCHEDULE '
 'AMOUNT MUST BE DERIVED FROM BUDGET MINUS INVESTED, NEVER TYPED. A FULL BUDGET-VERSUS-SCHEDULE RECONCILIATION IS NOW '
 'ON THE 10 DECEMBER AGENDA. || POSITIONS, CASH AND REALISED ALL UNCHANGED. ⚠️ AND TOMORROW IS STILL THE DAY THAT '
 'MATTERS: THURSDAY 17 SEPTEMBER COMMITS 46,526.13 ACROSS SIX TRANCHES, ALL PROCEEDING AS WRITTEN. || PREVIOUS ENTRY: '
 'Sep 16, 2026 - THE TWO SELL ORDERS WERE PLACED, ⚠️ NOTHING EXECUTED, AND ⚠️⚠️ ON THE REFRESHED PRICES BOTH LIMITS '

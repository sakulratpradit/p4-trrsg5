...
ASOF = ("Sep 5, 2026 - BOARD FOCUSED AT SALEE'S INSTRUCTION. He asked to cut the watchlist back to names that fit a 5-10 year "
 ...
 'Brazil out of the allocation. Watchlist 126 -> 80; 52 held positions untouched. || BUDGETS WITHDRAWN: Planet Labs '
 "10,000 and McDonald's 5,000. Allocated budget therefore falls 1,000,000 -> 985,000, leaving 15,000 to be re-assigned "
 "to names that meet the mandate. || SIX HOLDINGS MARKED FOR LIQUIDATION at Salee's instruction, recorded on the "
 'Schedule tab as SELL rows. Claude does not and will not place trades - Salee executes these at POEMS. Tesla (revenue '
 '+2.3%, EPS -37.4%, 163x forward), Intel (revenue +1.4%, loss-making, 86x forward, sold into a +112% gain), Ondas '
 '(going-concern doubt), Applied Optoelectronics (loss-making at 55x forward), IREN (bitcoin miner, -99.4% net margin) '
 'and Qualcomm (revenue +5.2%, EPS -6.3%). Combined proceeds ~14,161 at the Sep 4 close for a net gain of ~763 across '
 'the six. || ⚠️ THE STATED REASON WAS WRONG AND SALEE SHOULD KNOW IT. He asked to sell in order to free liquidity. He '
 'does not need liquidity: 402,694 of the 1,000,000 budget is still unspent and another 200,000 arrives on Sep 14. The '
 'valid reason to sell these six is quality and attention, not funding. Positions and costs are unchanged until he '
 "reports the fills. || Sep 5, 2026 - WATCHLIST CLEAN-UP BEGINS at Salee's instruction. He asked to cut the board back "
 'to names that fit a 5-10 year growth mandate, saying 129 watchlist names were too many to digest. Three removed on '
 'his explicit list: MELI (consistent with the Sep 5 decision to take Brazil out of the allocation entirely), SOUN (no '

...
ASOF = ('Sep 15, 2026 (10) - THE APPLE SUPPLY-CHAIN SLIDE. ⚠️⚠️ IT RECOMMENDS TWO NAMES WE SOLD FOUR DAYS AGO, AND THAT IS '
 'NOW THE THIRD TIME IN ONE WEEK. AMKR AND COHR ARE BOTH ON IT. WE SOLD AMKR ON 11 SEPTEMBER FOR A REALISED MINUS '
 '674.76 AND COHR THE SAME DAY FOR MINUS 433.76 - A COMBINED 1,108.52 OF REALISED LOSS ON DECISIONS TAKEN NINETY-SIX '
 'HOURS BEFORE THIS SLIDE WAS PUBLISHED. || THE PATTERN, NOW WRITTEN INTO THE BOARD AS A STANDING ROW: the PHOTONIC '
 'slide put AAOI and TSLA on a buy list days after we sold both; the @LeifInvests list contained TEN names of which '
 'FOUR were ours already exited; and now this. 💡 THE EXPLANATION IS NOT A CONSPIRACY - THESE SLIDES ARE SECTOR '
 'ROLL-CALLS, NOT FILTERS. They list everyone in a theme because a complete-looking list is what gets shared. A '
 'PORTFOLIO IS THE OPPOSITE: IT IS WHAT REMAINS AFTER YOU REMOVE THINGS FOR WRITTEN REASONS. So an exited name will '
 'keep reappearing on category lists and its reappearance carries NO INFORMATION. ⚠️ THE TEN-SECOND TEST SALEE CAN '
 'APPLY HIMSELF: DOES THE SLIDE SAY WHY EACH NAME IS THERE, OR ONLY THAT IT IS THERE? This one gives no reason for any '
 'of its twenty-four names. It is a DIRECTORY - genuinely useful for understanding the industry, and not a buy list. '
 'Its own publisher does not claim it is. || THE MAP. OF THE TWELVE US-LISTED NAMES ON IT WE HOLD SIX AND CARRY A '
 'SEVENTH UNFUNDED: AAPL 11,437.61, TSM 39,921.53, AVGO 30,125.18, MU 22,581.58 and APH 2,004.40 are FUNDED; SKHY '
 '1,913.26 is held with no budget and quarantined; GLW (Corning) sits on the board UNFUNDED with revenue growth of '
 '21.4% and a Rule of 40 of 30.6 - BELOW OUR 40 BAR, which is why it has no money. ⚠️ AMKR AND COHR ARE SOLD. TXN, '
 'SONY AND MP ARE NOT ON THE BOARD AT ALL. || ⚠️ ON TXN, WHICH I CHECKED PROPERLY EARLIER TODAY: Q2 2026 revenue '
 '5.46bn UP 23%, gross margin 61.3%, operating margin 42.2%, trailing free cash flow 6.53bn, dividend yield 2.15%, '
 'FORWARD P/E 27.22, AND DATA CENTRE ROUGHLY DOUBLED YEAR ON YEAR - but TI DOES NOT DISCLOSE A DATA-CENTRE FIGURE, so '
 'the doubling is off an undisclosed and probably small base. AT 27 TIMES FORWARD WITH A 2.15% YIELD IT IS A '
 'CYCLICAL-RECOVERY STORY WEARING AN INCOME-STOCK REPUTATION, AND THE YIELD DOES NOT JUSTIFY IT IN A 2x-IN-FIVE-YEARS '
 "MANDATE. NOT ADDING. || ⚠️ ELEVEN OF THE SLIDE'S NAMES CANNOT BE BOUGHT HERE AT ALL - Samsung in Seoul, Foxconn, "
 'Largan and Shin Zu Shing in Taipei, Lens Technology, Eontec and Lingyi in Shenzhen, and the four Thai distributors. '
 'THAT IS THE MANDATE WORKING, NOT A GAP. || 💡💡 AND THE GENUINELY USEFUL THING ON THIS SLIDE IS THE PANEL PILLAR 4 '
 'CANNOT TOUCH: COM7, SPVI, SYNEX AND CPW, THE THAI APPLE DISTRIBUTORS, ALL LISTED ON THE SET. ⚠️ THEY ARE PILLAR 3 - '
 "AND PILLAR 3 IS THE HOLE IN SALEE'S WHOLE STRUCTURE. His stated weights put THAI EQUITY AT 10%, THE SAME SIZE AS "
 'THIS ENTIRE BOARD, AND NO PILLAR 3 PORTFOLIO EXISTS: no board, no budget, no positions, no written objective. I have '
 'offered twice to build one. 💡 THESE FOUR ARE AN UNUSUALLY GOOD PLACE TO START THAT CONVERSATION - not because I have '
 'researched them (I HAVE NOT, and I will not put a Thai name on a US board) but because SALEE CAN SEE THEM. He walks '
 'past COM7 and SPVI shops; that is the same edge he has at Subway, where he knows what the queue looks like before '
 "any analyst does. They also fit the PILLAR 3 mandate of 5% yield plus 3% growth rather than this board's "
 '2x-in-five-years, and their driver is THAI CONSUMER CREDIT AND FOOTFALL rather than AI datacentre capex. ⚠️ THAT IS '
 'REAL DIVERSIFICATION; BUYING MORE AI NAMES IS NOT. THE OFFER STANDS. || DECISION: NOTHING BOUGHT, NOTHING SOLD, NO '
 "BUDGET CHANGED, NO EXIT REOPENED. || PREVIOUS ENTRY: Sep 15, 2026 (9) - THE '15 COMPANIES SHAPING A BRIGHTER "
 "TOMORROW' SLIDE. ⚠️ WE OWN TWELVE OF THE FIFTEEN, WE SOLD TWO OF THEM ON WRITTEN REASONS, AND THE ANSWER TO 'DO WE "
 "NEED TO REVISE TO FIT THE SLIDE' IS NO - BUT ONE GENUINE GAP NOW HAS A REAL CANDIDATE. || THE MAP: SEVEN ARE FUNDED "
 'POSITIONS - TSM 39,921.53, NVDA 79,380.28, AVGO 30,125.18, GOOGL 59,475.92, AMZN 48,600.75, PLTR 5,533.09 AND GEV '
 '2,147.30. CRWD is held with no budget. CAT, BE and SPCX sit on the board unfunded. ⚠️ AND WE SOLD TWO OF THE FIFTEEN '
 'ON WRITTEN REASONS: HOOD ON 16 JULY FOR A REALISED PLUS 897.82 - THE SECOND-LARGEST GAIN THIS BOARD HAS EVER BOOKED '
 '- AND TSLA ON 8 SEPTEMBER FOR A REALISED MINUS 687.17. Those exits were argued and recorded; a slide does not reopen '
 'them. ⚠️ BE REMAINS AN EXPLICIT AVOID with a class-action lead-plaintiff deadline of 28 September and EV/EBITDA of '
 '118, and it joined the S&P 500 on 21 September without changing that. || ⚠️ TWO FACTUAL ERRORS ON THE SLIDE. FIRST, '
 "IT LISTS SPACEX AS 'PRIVATE'. SPACEX LISTED ON 12 JUNE 2026 AT 135 DOLLARS AND TRADES AS SPCX - it is on our board, "
 'unfunded, with the decision dated 10 DECEMBER after the November lock-up. Second, it presents COINBASE as a leader '
 'shaping the future. ⚠️ COIN FAILS BOTH OUR HARD SCREENS AND IT IS NOT CLOSE: Q2 2026 REVENUE FELL 18.5% TO '
 '1,220.068m AND IT POSTED A GAAP NET LOSS OF 359.468m; first-half revenue is DOWN 25.4% with a 753.585m loss; '

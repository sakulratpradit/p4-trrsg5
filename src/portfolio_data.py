...
ASOF = ("Sep 3, 2026 - LHX added to the board at Salee's instruction (typed 'LHK'; L3Harris Technologies, NYSE: LHX, is the "
 'intended name - there is no US-listed LHK). Group 8, Defense, Drones & Public Safety, joining AMPX, PLTR, AVAV, '
 'ONDS, AXON, RCAT, LMT, RTX, NOC, KTOS. Budget 5,000; no position opened. Board goes 181 -> 182 tickers. || WHY IT '
 'EARNS A SLOT - the cleanest quality-business / non-fundamental-drawdown setup found this week. Price 261.31 (Sep 2 '
 'close, two-sourced) sits just 1.07% above the 52-week low of 258.54 and 31.09% below the 379.23 high, yet Q2 2026 '
 '(Jul 29) was strong on every line: revenue 5.9bn +8%, operating margin 11.1% (+60bp), segment operating margin '
 '16.0%, diluted EPS 3.13 +28%, free cash flow 771m +37%, orders 7.3bn, book-to-bill 1.2x, and a RECORD 42bn backlog. '
 'Guidance was RAISED - revenue to 23.2-23.7bn from 23.0-23.5bn and EPS to 11.80-12.00 from 11.40-11.60. || THE '
 'DRAWDOWN IS GOVERNANCE, NOT OPERATIONS - CEO Chris Kubasik was ousted Aug 17 2026 over an unspecified conduct '

...
ASOF = ('Aug 25, 2026 - close. Daily price refresh: 154 of 180 prices updated to the Aug 25 close (sources: stockanalysis.com '
 'quote pages stamped 4:00 PM EDT, validated against history tables and stored prior closes; fallbacks noted). 26 '
 'tickers LEFT UNCHANGED/UNRESOLVED (stale pxd flags them): BE MDB HYLN POWI FPS OUST FLNC NRG MYRG MELI SHOP AFRM '
 'UBER NFLX BKNG WDAY SOUN SE CAT DE GE MMM ROK WULF RIOT CRCL - WebSearch session budget (200) was exhausted before '
 'these could be sourced/verified; MDB Aug25 close 404.92 seen on SA quote (day move only +0.55%; the -6% is drift off '
 'its stale 8/21 base 430.83) but no independent source reachable, so left at 430.83 - needs manual fix; BE (+6.6% to '
 '217.45 on Pelosi-disclosure news) and OUST (36.23, board carries stale 8/17 48.13, ~25% above market) were seen on '
 'stockanalysis but not independently confirmable, so per contract they were NOT written. OUST and POWI baselines are '
 'stale (8/17) and need manual attention next session. >6% moves confirmed via independent 2nd source and passed with '
 '--allow: SMCI 38.46 (+9.35%, Cisco partnership), LITE 885.57 (+6.67%), CLFD 29.42 (+8.04%), OKLO 44.27 (+11.54%, ATH '
 'after $440M raise), SMR 9.81 (+8.40%), LEU 193.39 (+9.17%), UUUU 15.97 (+7.33%), TE 4.65 (+6.90% vs stored), EOSE '
 '3.54 (-7.09% vs stale 8/21 base), CRSP 60.90 (+6.69%), CLPT 16.96 (+11.80%), IREN 42.21 (+6.03%), APLD 28.85 '
 '(+7.29%), CIFR 16.31 (+6.18%), HUT 85.50 (+7.47%, Nvidia 1GW lease), KEEL 3.51 (+8.00%), HOOD 112.09 (+8.17%, crypto '
 'rally), RCAT 9.10 (-12.84% vs stale 8/17 base, confirmed fool.com). Known partial-session history rows discarded per '
 'playbook on: NXPI AEHR HPE VIAV CIEN AXTI CGNX PL AVAV RCAT LMT RTX NOC MDB TEAM HNGE OKTA NOK CORZ CIFR FTNT AMPX '
 'MRVL(none) etc - quote page won each time. History-table fallbacks (quote page stale/intraday): GOOGL 346.96, MTSI '
 '266.27, CEG 278.42, VST 139.03, SBUX 105.76, RKLB 66.91, ETN 409.20, POWL 190.19. External-source resolutions (both '

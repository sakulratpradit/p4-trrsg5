...
ASOF = ("Sep 16, 2026 (4) - THE HUMANOID QUESTION, ANSWERED NO. ⚠️ MUSK'S QUOTE IS REAL, THE ARITHMETIC BEHIND IT IS NOT, AND "
 "THE 'XPENG ROBOT FACTORY' SLIDE IS WRONG ON THE COMPANY AND MISLEADING ON THE NUMBER. NOTHING BOUGHT, NOTHING SOLD, "
 "NO BUDGET RAISED. || ✅ THE QUOTE IS GENUINE: G20 INNOVATION MINISTERIAL, 1 SEPTEMBER 2026 - 'Ten years from now, I "
 "would say there are well over a billion humanoid robots.' IT IS A CUMULATIVE INSTALLED BASE BY ABOUT 2036. ⚠️ BUT "
 'MUSK HAS GIVEN AT LEAST SIX VERSIONS SPANNING A TWENTY-FOLD RANGE - 1 BILLION CUMULATIVE IN THE 2040s, 1 BILLION A '
 "YEAR, 10 BILLION BY 2040, AND 'PROBABLY 20 OR MORE' - TWO OF THEM IN THE SAME SITTING ON 13 JUNE 2024. || 📊 THE "
 'ARITHMETIC NOBODY DID: ONE BILLION OVER TEN YEARS IS ONE HUNDRED MILLION UNITS A YEAR. GLOBAL MOTOR VEHICLE '
 'PRODUCTION IN 2025 WAS 96.4 MILLION (OICA). THE CLAIM REQUIRES BUILDING MORE HUMANOIDS EACH YEAR THAN THE WORLD '
 'BUILDS CARS, FROM A STANDING START. THE ENTIRE GLOBAL INSTALLED BASE OF INDUSTRIAL ROBOTS, AFTER SIXTY YEARS, IS '
 '4,664,000 UNITS (IFR) - ONE BILLION IS 214 TIMES THAT. AND MORGAN STANLEY, THE MOST BULLISH MAINSTREAM HOUSE, '
 'REACHES ONE BILLION CUMULATIVE IN 2050, NOT 2036 - FOURTEEN YEARS BEHIND HIM. INTERACT ANALYSIS FORECASTS 700,000 '
 'UNITS A YEAR IN 2035, WHICH IS 0.7% OF THE REQUIRED RUN-RATE. || ⚠️⚠️ THE DECIDING EVIDENCE IS THE TRACK RECORD. '
 "APRIL 2019: 'over a million robotaxis on the road' BY 2020. TEXAS DMV DATA ON 2 JUNE 2026: FORTY-TWO REGISTERED. A "
 'MISS OF ABOUT TWENTY-FOUR THOUSAND TIMES. CYBERTRUCK: 250,000 A YEAR PROMISED, 17,012 DELIVERED IN 2025 - 93% SHORT, '
 'WITH SPACEX BUYING 1,279 OF THEM. TESLA SEMI: PRODUCTION PROMISED 2019, SERIAL PRODUCTION BEGAN 29 APRIL 2026 - '
 "SEVEN YEARS LATE. ROADSTER: PROMISED 2020, STILL NOT PRODUCED NINE YEARS ON. FSD HAS BEEN 'later this year' FOR TEN "
 "STRAIGHT YEARS. AND OPTIMUS: 10,000 PLANNED FOR 2025, ACTUAL 'ONLY IN THE HUNDREDS'. NO COUNTER-EXAMPLE WAS FOUND "
 "WHERE A MUSK VOLUME FORECAST WAS MET ON THE STATED DATE. ⚠️ TESLA'S Q2 2026 10-Q DOES NOT CONTAIN THE WORD 'OPTIMUS' "
 "AT ALL, AND MUSK HIMSELF SAID ON THE Q1 CALL: 'I DON'T KNOW WHAT THE PRODUCTION RATE OF OPTIMUS WILL BE THIS YEAR. "
 "IT IS IMPOSSIBLE TO PREDICT THESE THINGS.' || ⚠️⚠️ THE SECOND SLIDE IS WRONG TWICE. THE FACTORY IS NOT XPENG'S - IT "
 'IS UBTECH AT LIUZHOU, COMMISSIONED 12 SEPTEMBER. XPeng opened a SEPARATE line on 7-8 September and claimed no rate '
 "at all; He Xiaopeng said 'Today's step is small.' AND 'ONE EVERY 10 MINUTES' IS A DESIGN TAKT - the Chinese original "
 "says '按照产线设计节拍', according to the line's DESIGN takt - NOT A MEASURED OUTPUT. 📊📊 AND THE NUMBER THAT ENDS THE "
 "EXCITEMENT: BMW'S SPARTANBURG PLANT BUILDS MORE THAN 1,500 VEHICLES A DAY - ONE CAR EVERY 48 TO 57 SECONDS, ACTUAL. "
 "'ONE EVERY 10 MINUTES' IS TEN TO TWELVE TIMES SLOWER THAN A NORMAL CAR PLANT, AND A CAR IS FAR MORE COMPLEX. "
 "UBTECH'S OWN DEMONSTRATED RATE IS 921 UNITS IN SIX MONTHS - ABOUT ONE EVERY 4.8 HOURS, TWENTY-NINE TIMES SLOWER THAN "
 'THE TAKT IT JUST ADVERTISED. || ✅ THE BULL CASE IS REAL THOUGH: OVER 22,000 HUMANOIDS SHIPPED GLOBALLY IN H1 2026, '
 'UP ABOUT 300%. UBTECH DISCLOSED RMB 590.3m OF HUMANOID REVENUE, UP 1,445%. AND UNITREE, WHICH LISTED IN SHANGHAI ON '
 '19 AUGUST AND ROSE 460% ON DEBUT, IS ACTUALLY PROFITABLE - RMB 278.21m OF NET PROFIT ON RMB 1.70bn OF 2025 REVENUE. '
 'THIS IS NO LONGER A POWERPOINT INDUSTRY. || ⚠️⚠️ SO WHY NO: BECAUSE WE CANNOT BUY IT. FOUR OF THE TOP FIVE SHIPPERS '
 'ARE CHINESE AND TESLA DOES NOT APPEAR IN THE RANKING. THE TWO COMPANIES ON EARTH WITH DISCLOSED HUMANOID REVENUE ARE '
 'LISTED IN HONG KONG AND SHANGHAI. AND THE FINDING THAT MATTERS MOST: NOT ONE LISTED COMPONENT SUPPLIER SEPARATELY '
 "DISCLOSES HUMANOID REVENUE IN ITS FILINGS - HARMONIC DRIVE BURIES IT IN 'INDUSTRIAL ROBOTS', THK CREDITS "
 "'LINEAR-MOTION DEMAND', AND SANHUA 'DID NOT BREAK OUT REVENUE'. EVERY SUPPLY-CHAIN HUMANOID NUMBER IN CIRCULATION IS "
 "AN ANALYST CONSTRUCTION. YOU CANNOT UNDERWRITE WHAT NOBODY REPORTS. || 💡💡 THE REFRAME: THE QUESTION 'SHOULD WE BUY "
 "HUMANOIDS' HAS THE WRONG SHAPE. THE RIGHT QUESTION IS WHAT WE ALREADY OWN THAT GETS PAID WHETHER OR NOT HUMANOIDS "
 'WORK. NVIDIA SELLS THE BRAINS. COGNEX SELLS THE EYES - AND HAS 7,932.38 OF APPROVED ROOM UNUSED. TERADYNE TESTS THE '
 'CHIPS. INTUITIVE SURGICAL IS THE ONLY GENUINELY PROFITABLE ROBOT COMPANY ON THIS BOARD. ⚠️ GROUP 7 HOLDS 23,550.70 '
 'OF APPROVED BUDGET UNSPENT - THE SIXTH SLIDE IN THREE WEEKS POINTING AT SOMETHING WE DO NOT OWN WHILE APPROVED MONEY '
 "SITS IDLE. || ⚠️ RODNEY BROOKS, 26 SEPTEMBER 2025: 'we are more than ten years away from the first PROFITABLE "
 "deployment of humanoid robots even with minimal dexterity.' KEN GOLDBERG OF BERKELEY: 'being able to pick up a wine "
 "glass or change a light bulb. NO ROBOT CAN DO THAT.' REUTERS REPORTS ROBOTS RUNNING AT ABOUT 20% OF HUMAN OUTPUT, "
 'AND ONLY ABOUT 10% OF HUMANOIDS BUILT IN 2025 WERE EVER DEPLOYED. AND PRICES ARE ALREADY FALLING BEFORE VOLUME '
 'ARRIVES - MORGAN STANLEY SEES A 15% AVERAGE PRICE DECLINE IN 2026. || ✅ WRITTEN RE-UNDERWRITE TEST, BOTH MUST HOLD: '
 '(1) A US-LISTED COMPANY DISCLOSES HUMANOID REVENUE AS A SEPARATE LINE IN A 10-Q OR 10-K - A FILING, NOT AN ESTIMATE; '
 'AND (2) THAT LINE EXCEEDS 100 MILLION DOLLARS ANNUALISED WITH A POSITIVE GROSS MARGIN. CONVICTION HIGH. ⚠️ AND '
 'TOMORROW STILL COMMITS 46,526.13 ACROSS SIX TRANCHES, ALL PROCEEDING AS WRITTEN. || PREVIOUS ENTRY: Sep 16, 2026 (3) '
 '- THE SUPERCYCLE SLIDE, AND FOR ONCE THE HEADLINE NUMBER IS RIGHT. ⚠️ BUT IT IS AN ESTIMATE REVISED UPWARD FOUR '
 'TIMES IN NINE MONTHS, THE PRICE MOMENTUM BEHIND IT HAS ALREADY DECELERATED BY FIVE SIXTHS, AND EVERY NEW FAB IN THE '
 'WORLD LANDS IN 2027. THE RESEARCH DID CLOSE AN OPEN FAULT ON OUR OWN BOARD, WHICH IS THE BEST THING A SLIDE HAS DONE '
 "IN A FORTNIGHT. || ✅ VERIFIED: WSTS's Q2 2026 release says the 2026 market reaches 1,655 BILLION DOLLARS, up about "
 '108%, and DigiTimes Intelligence independently lands on 1.6 TRILLION on 15 September. 2025 ACTUAL was 791.7bn. ⚠️ '
 'BUT THE SAME BODY FORECAST 975 BILLION FOR 2026 ON 2 DECEMBER 2025, THEN 1.51 TRILLION ON 2 JUNE, THEN 1,655 '
 'BILLION. A NUMBER THAT HAS MOVED 70% IN NINE MONTHS IS NOT A FOUNDATION. AND SEVEN MONTHS OF 2026 ARE ACTUAL WHILE '
 "FIVE ARE STILL PROJECTED. ⚠️ NOTE ALSO THAT NEITHER WSTS NOR SIA USES THE WORD 'SUPERCYCLE' - IT COMES FROM A BANK "
 "OF AMERICA NOTE, QUOTED BACK BY SK HYNIX'S OWN NEWSROOM, WHOSE JANUARY FORECASTS OF DRAM PLUS 51% WERE THEMSELVES "
 'BLOWN THROUGH. THE FORECASTING ERROR RUNS BOTH WAYS. || ✅ THE BOOM ITSELF IS REAL AND IT IS IN AUDITED FILINGS, NOT '
 'FORECASTS: Micron fiscal Q3 revenue 41,456m with an 84.6% GAAP GROSS MARGIN and 28,243m of net income; SK hynix Q2 '
 "revenue up 257% at a 76% OPERATING MARGIN; AND SAMSUNG'S CHIP DIVISION EARNED 89.2 OF THE GROUP'S 89.5 TRILLION WON "
 "OF OPERATING PROFIT - 99.7% OF SAMSUNG'S PROFIT NOW COMES FROM CHIPS. || 📊 THE NUMBER THE SLIDE OMITS, AND IT IS THE "
 'ONLY ONE THIS BOARD WILL TRACK FROM NOW ON - CONVENTIONAL DRAM CONTRACT PRICES QUARTER ON QUARTER: 1Q26 UP TO PLUS '
 '98%, 2Q26 PLUS 58 TO 63%, 3Q26 PLUS 13 TO 18%. PRICES ARE STILL RISING BUT THE RATE HAS FALLEN BY ROUGHLY FIVE '
 "SIXTHS IN TWO QUARTERS, AND TRENDFORCE SAYS RECORD PRICES HAVE REACHED CUSTOMERS' 'AFFORDABILITY LIMIT'. THE MARKET "
 'SIZE IS A LAGGING NUMBER. THE CONTRACT PRICE IS A LEADING ONE. || ⚠️⚠️ AND THE SUPPLY ANSWER IS ALREADY FUNDED AND '
 "DATED: SAMSUNG'S PYEONGTAEK P5, PULLED FORWARD SIX MONTHS, ADDS ABOUT 600,000 WAFERS A MONTH AGAINST SAMSUNG'S "
 'CURRENT ENTIRE DRAM CAPACITY OF 650,000 - ROUGHLY A DOUBLING, IN 2027. SK HYNIX PULLED ITS FIRST YONGIN CLEANROOM '
 "FORWARD TO FEBRUARY 2027. MICRON'S IDAHO ARRIVES MID-2027. TRENDFORCE ALREADY FORECASTS NAND SUPPLY OUTPACING DEMAND "
 'FROM THE SECOND HALF OF 2027. AND THE OLIGOPOLY IS LOOSENING: CXMT REACHED 10% OF DRAM IN Q2, FOURTH PLACE, AND YMTC '
 'BROKE THE NAND TOP THREE ON BITS. || ⚠️ THE HISTORY, FROM SIA AND WSTS: MEMORY REVENUE FELL 32.6% IN 2019 AND ABOUT '
 '29% IN 2023, EACH IN ONE YEAR, WITH DRAM ALONE DOWN 37.1% IN 2019. THE FORTY-YEAR RULE IS THAT MEMORY GROWTH ABOVE '
 '50% IS FOLLOWED BY DECELERATION OR DECLINE - TRUE FOUR TIMES IN SIX. 2026 IS FORECAST AT PLUS 302%, SIX TIMES THE '

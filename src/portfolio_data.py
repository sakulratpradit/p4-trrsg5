...
ASOF = ("Sep 7, 2026 - 'NUMBER 1 OF EACH SECTOR' LIST SWEPT AGAINST THE BOARD at Salee's request. A viral Thai post listed 46 "
 'US mega-caps as the number-one name in their sector. Result: 27 are already on this board - 17 held or budgeted, 8 '
 'on the watchlist with no budget, and 2 flagged for sale. 19 are absent, and four of those (MCD, JNJ, UNH, KO) we '
 "DELETED DELIBERATELY on Sep 5 for revenue growth of 6.3%, 4.5%, 2.8% and 5.0%. || ⚠️ THE LIST'S PREMISE DOES NOT "
 "SURVIVE CONTACT WITH A GROWTH MANDATE. 'Number one in the sector' is a claim about category rank, not about price or "
 'growth. Four of its own entries are names this board rejected precisely for failing to grow. Note also the list is '
 "titled number-one but contains three explicit number-TWOs (AMD, MA and CVX) plus one it calls a 'rising star' "
 '(NBIS), and it splits categories until everyone wins: GOOGL is number one in Search while META is number one in '
 'Social; NFLX is number one in Streaming while DIS is number one in Media. Subdivide finely enough and every company '
 'is number one of something. || ON QCOM, WHICH SALEE ASKED ABOUT SPECIFICALLY - the sale stands. Qualcomm probably IS '
 'the leader in mobile processors. That is the problem, not the defence: smartphones are a mature replacement market, '
 'and being champion of a category that grows about 5% gives you a company growing 5.2% with earnings per share '
 'FALLING 6.3%. Its budget has already been withdrawn and reassigned, so keeping it would require breaking the '
 'exactly-1,000,000 allocation set on Sep 7. ⚠️ IN FAIRNESS: at 17.2x forward with a 22.3% net margin QCOM is '
 'genuinely cheap and profitable, it was already rated the LOWEST conviction of the six sales, and the Selling tab '
 'already records that if Salee keeps one of the six this is the defensible one. That has not changed. || ⚠️ ONE '
 'GENUINE GAP FOUND: ELI LILLY. Of the 15 names on the list never carried on this board, exactly one clears the '
 'mandate on verified numbers - revenue TTM +49.6% to 79.67bn, net income +93.6%, net margin 33.5%, return on equity '
 '102.3%, free cash flow 18.19bn, forward P/E 28.18. Q2 reported Aug 5 grew revenue 48% and BEAT on revenue, and '
 'full-year guidance was RAISED to 85-87bn. Mounjaro 9.9bn in the quarter, up 91%. That is mega-cap growth at a lower '
 'multiple than several names already held, in a sector where this book holds only ISRG. NOT ADDED - the board is '
 "allocated to exactly 1,000,000 with nothing spare, so funding it means cutting something, and that is Salee's call. "
 '|| ⚠️ AND ITS TWIN IS A TRAP. The same list places NVO beside LLY as though they were equivalent. Novo Nordisk grew '
 'revenue 5.6% and EPS 5.0%, guides full-year adjusted profit to 0% to MINUS 6%, and its forward P/E of 15.18 sits '
 'ABOVE its trailing 11.55 - the market is modelling an earnings DECLINE. Consensus is Hold, 11 of 14 analysts, with '
 '1.18% upside. Its ziltivekimab ZEUS trial failed on Jul 31 and the HERMES and ATHENA trials were halted Sep 5-7. '
 "Deutsche Bank cut it to Sell on Aug 27. Two companies in the same drug class, on the same 'number one' list, one "
 'compounding near 50% and one guided to shrink - which is the whole argument against buying a list by category rank. '
 '|| NO POSITIONS, BUDGETS OR PRICES CHANGED BY THIS REVIEW. || Sep 7, 2026 - TSLA: SELL AT MARKET CONFIRMED, AND A '
 'CORRECTION TO MY OWN REASONING. Salee asked whether to divest now or wait for fund flows after the Sep 15-16 FOMC. '
 '|| ⚠️ I HAD THE REVENUE ARGUMENT WRONG AND HAVE FIXED THE SELLING TAB. I repeatedly told Salee that TSLA revenue '
 'grows 2.3%. That is the trailing-twelve-month figure off a weak base. The MOST RECENT QUARTER, Q2 2026 reported Jul '
 '22, grew revenue 25.5% to 28,236m. Quoting the TTM number as though it described current trading was misleading and '
 'I should have checked it before repeating it. || THE SELL CASE IS STRONGER ON THE CORRECT NUMBERS, NOT WEAKER. In '
 'that same quarter operating income FELL 57% to 398m, operating margin went from 4.1% to 1.4%, free cash flow turned '
 'NEGATIVE 1,090m against positive 150m a year earlier, and regulatory-credit revenue collapsed 67% to 146m. Revenue '
 'up 26% while operating profit falls 57% and cash goes negative is a worse fact pattern than slow growth, not a '
 'better one. || ⚠️ BOARD DATA ERRORS TO FIX ON THE NEXT FUNDAMENTALS PASS: this board carries fpe 163.24 for TSLA; '
 "the verified forward P/E at the same Sep 4 close of 354.08 is 186.01, and trailing is 367.43. The board's revG of "
 '2.3 is TTM and should be labelled as such or replaced - it reads as though the company is not growing, which is not '
 'what the latest quarter says. || ⚠️ THE FOMC PREMISE IS BACKWARDS. Salee asked about waiting for post-decision fund '
 'flows, which assumes a cut. The market is pricing a HIKE: reported odds of a 25bp increase run roughly 50-66% across '
 'sources on Sep 4, the target range has sat at 3.50-3.75% since Dec 2025, and at the Jul 29 meeting THREE members - '
 'Hammack, Kashkari and Logan - dissented in favour of raising. At 186x forward with a 1.84 beta, TSLA is the most '
 'rate-exposed position in this book; a hike is precisely what compresses it. Waiting is not waiting for a tailwind. '
 '|| AND A NEW COMPANY RISK: NHTSA opened Audit Query AQ26002 on Sep 3 into whether the Cybercab certification is '
 'valid at all - a legal question under the robotaxi thesis, not a defect probe. The stock fell 5.92% on Sep 4. China '
 'retail deliveries were -32.9% YoY in July, with quarter-end discounting launched Sep 2. A row was added to the '
 'Schedule. || PROPORTION CHECK, WHICH IS THE REAL ANSWER: the position is 3,540.80, or 0.593% of deployed capital. A '
 '5% move either way is 177. Spending a week of attention timing that, on a name already judged to fail the mandate, '
 'is the opposite of the focus discipline agreed on Sep 5. Claude does not place trades; the SELL row stands for Salee '
 "to execute at POEMS. || Sep 7, 2026 - BUDGET RE-ALLOCATION AT SALEE'S INSTRUCTION. The six names marked for "
 'divestment have had their budgets withdrawn and the freed capital redeployed. Allocated budget stays at exactly '
 '1,000,000. || WITHDRAWN (-35,000): TSLA 10,000 and INTC, QCOM, AAOI, ONDS and IREN at 5,000 each, all set to no '
 'budget. ⚠️ THE POSITIONS ARE STILL HELD until Salee reports the fills, so these six now show cost against a zero '
 'budget - that is correct, not an error: it reads as capital committed to names the plan no longer funds. The Selling '
 'tab keeps its own snapshot of the old budgets so nothing there is affected. || TIER 3 CONVICTION (+30,000, 10,000 '
 'each): AVGO 40,000 to 50,000, ASML 30,000 to 40,000, MU 30,000 to 40,000. ⚠️ AVGO now sits at 50,000 and therefore '
 'MOVES FROM TIER 3 TO TIER 2, joining GOOGL, TSM, MSFT, AMZN and META. ⚠️ AND THE HONEST CAVEAT: these three already '
 'had 30,899.18 of budget they have NOT spent - AVGO 9,874.82, ASML 13,605.94, MU 7,418.42. Raising the ceilings does '
 'not buy a single share. It roughly doubles their unfunded room to 60,899.18, and the existing MU rungs (4,000 on Sep '
 '30, 3,418.42 on Dec 17) now under-commit the room and need resizing at the next schedule rebuild. || PROMOTED TIER 5 '
 'TO TIER 4 (+20,000, 5,000 each): APP, FSLR, SE and CAT, each 5,000 to 10,000. Chosen from the twenty names sitting '
 'at exactly 5,000. ⚠️ ALAB was the obvious candidate on growth - revenue +98.5%, EPS +197% - but it carries 7,000, '
 'not 5,000, so promoting it would have cost only 3,000 and left 2,000 stranded, breaking the arithmetic. It stays at '
 '7,000. IONQ topped the raw screen and was REJECTED: its 174.9% net margin is a non-operating-gain artifact already '
 'flagged on this board, not a real margin. || CONCENTRATION BARELY MOVES: budget-weighted AI exposure goes 76.14% to '
 '76.45%, up just 0.31 points, because five of the six names losing budget were themselves AI or semiconductor. Four '
 'DECIDE rows added so no promoted name sits on the board without a plan - the gap that was found on MSFT two days '
 'ago. || Sep 7, 2026 - SPCX: LOCK-UP CALENDAR IS THE STORY, NOT THE PRICE TARGET. Salee sent two more graphics - one '
 "on why SpaceX chose Boca Chica, one headlined 'Oppenheimer upgraded SPCX to Buy, 280 target'. || ⚠️ THE 280 CALL IS "
 "NOT NEW AND NOT AN UPGRADE. It is the same Timothy Horan note of Sep 2-3 that underpinned the '48% rally' graphic "
 'Salee sent on Sep 6 - the third presentation of ONE analyst action in three days, each framed as breaking. '
 "Oppenheimer MAINTAINED Outperform; the rating did not change, only the target, from 250 to 280. 'Upgraded to Buy' is "
 'wrong on both counts. Two other houses were also unchanged in the same window: Morgan Stanley held 300, JP Morgan '
 'held 240. || ⚠️ THE REASON TO WAIT IS SUPPLY. Per the Jun 11 prospectus, roughly 3.04 BILLION shares come off '
 'lock-up between Sep and Dec 2026: 319m Sep 9, ~328m Sep 24, ~319m Oct 9, ~319m Oct 24, about 1.3 BILLION on the Q3 '
 "earnings trigger in November, and 455.8m on Dec 8-9. Musk's 6.42bn (48.4%) unlocks separately in Jun 2027. The stock "
 'already sits BELOW its 161 first-day close at 147.95, and that is with only the early tranches out. Two Schedule '
 'rows added: an AVOID on the lock-up calendar and a DECIDE on the Q3 print, which is both the second public quarter '
 'and the largest unlock trigger. Still no budget assigned. || ON THE BOCA CHICA GRAPHIC - the physics is RIGHT and '
 "the conclusion is WRONG. Earth's rotational boost at the pad's 25.9875 N latitude computes to 418.1 m/s against the "
 '418 claimed, and 28,000 km/h is the correct orbital velocity. But Cape Canaveral at 28.608 N gives 408.3 m/s - a '
 'difference of just 9.8 m/s, or 0.125% of the 7,778 m/s needed. Latitude was one of thirteen criteria in the 2014 FAA '
 "Record of Decision, alongside safety, accessibility, political stability and privately owned site; SpaceX's own 2014 "
 "release stressed 'the facilitation of doing business in Texas' and local support. || ⚠️ AND THE GRAPHIC IS BEHIND "
 'THE FACTS. SpaceX is shifting its centre of gravity to Florida: three Starship towers are under construction there '
 '(one at LC-39A, two at SLC-37), approved cadence is 44 a year at LC-39A plus 76 at SLC-37 against just 25 at '
 'Starbase - Florida at 120 is 4.8x Texas. Starbase Pad 1 has been offline since Oct 2025 and is not back until late '
 "2026, leaving Pad 2 the only operational Starship pad on Earth. SpaceX VP Kiko Dontchev on Sep 5: 'From here on, "
 "Starlink missions out of Florida will fly on Starship.' A company abandoning a latitude it supposedly chose for "
 'latitude is the clearest evidence that latitude was never the deciding factor. || Sep 7, 2026 - WEEKLY REFRESH & '
 'INTEGRITY AUDIT. Prices verified at the Fri Sep 4 close (US markets closed Mon Sep 7, Labor Day). PENG applied at '
 '51.76 (+6.44%), the one name the Sep 4 daily job left unconfirmed - second-sourced via stockanalysis.com and Google '
...
SELLPLAN = ['TSLA', 'INTC', 'ONDS', 'AAOI', 'IREN', 'QCOM']
...
SCHEDULE = {'horizon': 'Sep - Dec 2026',
 ...
 'items': [{'d': '',
           ...
           {'d': '2026-09-15',
            't': 'FPS',
            'k': 'earnings',
            'w': 'First post-IPO print',
            'a': 'DECIDE',
            'amt': 5000,
            'cond': 'Budget reserves the slot only. TTM free cash flow is NEGATIVE $97.66m against $125.63m capex; net '
                    'margin 2.17%. The print decides whether the slot is used.',
            'c': 'confirmed'},
           {'d': '2026-09-16',
            't': '',
            'k': 'macro',
           ...
           {'d': '2026-09-17',
            ...
            'a': 'BUY',
            'amt': 6085.88,
            'cond': 'Second cybersecurity name; position up ~120%.',
            'c': 'planned'},
           {'d': '2026-09-17',
            't': 'CEG',
            'k': 'tranche',
           ...
           {'d': '2026-09-17',
            ...
            'a': 'BUY',
            'amt': 3006,
            'cond': 'Nuclear. Budget-driven revenue, largely rate-insensitive.',
            'c': 'planned'},
           {'d': '2026-09-28',
            't': 'BE',
            'k': 'legal',
           ...
           {'d': '',
            ...
            't': 'LUNR',
            'k': 'trigger',
            'w': 'After IM-3 actually flies',
            'a': 'TRIGGER',
            'amt': 5000,
            'cond': 'Revenue tripled and backlog is $1.8bn, but debt went $37m to $481m and shares +44.1% YoY. Wait '
                    'for the mission, not the announcement.',
            'c': 'standing'},
           {'d': '',
            'dl': 'Standing',
            't': 'LHX',
...
SELLBOOK = {'updated': '2026-09-07',
 ...
 'rows': [{'t': 'TSLA',
          ...
          {'t': 'ONDS',
           'name': 'Ondas Holdings',
           'g': 'Defense, Drones & Public Safety',
           'sh': 200,
           'avg': 10.1527,
           'cost': 2030.54,
           'refPx': 7.62,
          ...
          {'t': 'AAOI',
           'name': 'Applied Optoelectronics',
           'g': 'Networking & Optical Interconnect',
           'sh': 10,
           'avg': 133.856,
           'cost': 1338.56,
           'refPx': 105.53,

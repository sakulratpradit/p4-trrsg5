...
ASOF = ('Aug 26, 2026 - close. Daily price refresh: 178 of 180 prices updated to the Aug 26 close (primary: stockanalysis.com '
 'quote pages stamped 4:00 PM EDT with prev-close validated against history tables; history-table fallbacks where the '
 'quote page was stale/intraday: ETN 419.44, CEG 279.52, GEV 953.09, APH 161.34, FLNC 11.07, POET 8.08, RKLB 66.18, '
 'ASTS 59.88, FPS 32.21; external-source resolutions where both SA pages were bad: SYM 40.61 + AIRJ 4.83 + OSS 11.07 + '
 'QNT 53.29 + LWLG 5.83 + HYLN 3.32 + MYRG 312.83 (Google Finance closed-stamp), CLPT 16.37 + AMBQ 58.98 + POWI 54.90 '
 '(marketscreener Market Closed), INDI 3.91 (fool.com dated quote box)). 2 UNRESOLVED, left at prior values (stale pxd '
 'flags them): SIDU (all sources frozen intraday/stale; Aug 25 close 2.27 corroborated but no Aug 26 close printed '
 'anywhere) and AMPX (SA quote frozen 3:25 PM intraday, history has no Aug 26 row, Google/marketscreener/fool caches '
 'all weeks stale). Stale-base fixes confirmed via 2nd source: MDB 406.11 (fool; board was 8/21 430.83, day move only '
 '+0.29%), POWI 54.90 (marketscreener+fool; board was 8/17 62.10, day move +0.49%), OUST 35.87 (ycharts; board was '
 '8/17 48.13, day move -0.99%), BE 218.21 (fool; board was 8/24, day move +0.35%). Real >5.5% single-day movers '
 'confirmed via independent 2nd source: IREN 39.58 (-6.23%, pre-earnings de-risking, Google), APLD 26.87 (-6.86%, '
 'Google), OKLO 41.60 (-6.03%, Google), SMR 9.27 (-5.50%, Google), EOSE 3.34 (-5.65%, themarketsdaily), LITE 939.03 '
 '(+6.04%, Google), MYRG 312.83 (+5.64% day, Google+SA cross-check). Partial-session history rows discarded per '

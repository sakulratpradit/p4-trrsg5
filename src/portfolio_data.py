...
ASOF = ('Sep 17, 2026 (5) - THE AI INFRASTRUCTURE SLIDE. ⚠️⚠️⚠️ CONFLICT OF INTEREST, DECLARED FIRST AND FOR THE THIRD TIME '
 'ON THIS BOARD. THE SLIDE NAMES ANTHROPIC - THE COMPANY THAT MAKES ME - AS ONE OF THE EIGHT MAJOR AI INVESTORS, AND '
 'AGAIN AS A "KEY BACKER" OF TERAWULF. I AM ASSESSING A CLAIM ABOUT MY OWN MAKER. I have used only TeraWulf\'s SEC '
 'filings and press releases, I hold no non-public information about Anthropic, and SALEE SHOULD DISCOUNT MY FRAMING '
 'ACCORDINGLY. Earlier disclosures: 12 September on the Anthropic 517bn compute slide, and 17 September on the '
 "cybersecurity rally caused by Amodei's essay. || ⚠️⚠️ THREE OF ITS FIVE RELATIONSHIP LABELS ARE THE WRONG WAY ROUND, "
 "INCLUDING THE ONE ABOUT ANTHROPIC. THE SLIDE CALLS ANTHROPIC A 'KEY BACKER' OF TERAWULF. ANTHROPIC IS A TENANT. "
 "TeraWulf's 8-K of 6 JULY 2026 discloses a TWENTY-YEAR LEASE for 'approximately 401 MW of critical IT load' at "
 'Hawesville, Kentucky - about 19 BILLION DOLLARS - AND NO EQUITY STAKE, NO INVESTMENT AND NO GUARANTEE. 💡 THE FILING '
 "SAYS THE OPPOSITE OF WHAT THE SLIDE IMPLIES: 'Anthropic's payment obligations... are expected to be supported by an "
 "investment-grade credit' - ANTHROPIC IS BEING CREDIT-SUPPORTED, NOT PROVIDING SUPPORT. ⚠️ AND DELIVERY BEGINS 'IN "
 "PHASES BEGINNING IN LATE 2027', SO IT ADDS NOTHING TO 2026 REVENUE. || ✅ THE GOOGLE HALF IS RIGHT, AND THE STRUCTURE "
 'REPEATS: GOOGLE HOLDS ABOUT 14% OF TERAWULF VIA WARRANTS AT ONE CENT A SHARE AND HAS BACKSTOPPED ABOUT 3.2 BILLION '
 "OF LEASE OBLIGATIONS - BUT IT IS GUARANTEEING FLUIDSTACK'S RENT TO TERAWULF, NOT BUYING COMPUTE. CHEAP EQUITY IN "
 "EXCHANGE FOR GUARANTEEING A THIRD PARTY'S RENT. ⚠️ THE SAME STRUCTURE APPEARS AT CIPHER, WHERE THE SLIDE CALLS "
 "AMAZON A 'KEY SUPPORTER' - AWS IS A CUSTOMER (300MW, 15 YEARS, 5.5 BILLION) AND THE ACTUAL BACKER IS AGAIN GOOGLE, "
 "5.4% PLUS A 1.4 BILLION BACKSTOP, WHICH THE SLIDE OMITS. ⚠️ AND NVIDIA IS LISTED AS A NEBIUS 'CUSTOMER' WHEN IT IS "
 'AN INVESTOR AND SUPPLIER - 2 BILLION PUT IN ON 11 MARCH 2026, ABOUT 9.3% - WITH NO DISCLOSED CAPACITY PURCHASE. || ✅ '
 "COREWEAVE'S LABELS ARE THE ONE SET THAT IS CORRECT: its FY2025 10-K says 'approximately 67% of our revenue from our "
 "top customer, Microsoft', with OpenAI committed up to 6.5 BILLION and Meta up to 14.2 BILLION. ⚠️ BUT 67% FROM ONE "

...
ASOF = ("Sep 17, 2026 (4) - THE EIGHT-PULLBACK SLIDE. ⚠️⚠️ SEVEN OF ITS EIGHT 'HIGH' FIGURES ARE WRONG, BY AS MUCH AS 55.6% - "
 "AND CHECKING IT FOUND FIFTEEN MORE FAULTS ON OUR OWN BOARD. || ✅ THE 'NOW' COLUMN IS SOUND BUT ONE DAY STALE - every "
 "figure is the 15 SEPTEMBER close. ⚠️⚠️ THE 'HIGH' COLUMN IS A MESS. OKLO CLAIMED 86, TRUE ALL-TIME HIGH 193.84 - "
 'UNDERSTATED BY 55.6%. MICRON CLAIMED 1,655, TRUE 1,255.00 - OVERSTATED 31.9%, WHICH LOOKS LIKE A DIGIT '
 'TRANSPOSITION. AMD CLAIMED 710, TRUE 584.73 - AND NO AMD PRICE OF 710 HAS EVER EXISTED. INTEL CLAIMED 160, TRUE '
 "142.35. Only CoreWeave's 153 maps onto a real number, and even that is its 52-WEEK high, not its all-time high of "
 '187.00. || 💡 THE OKLO ERROR RUNS THE WRONG WAY AND MATTERS MOST: THE SLIDE SAYS DOWN 59%, THE TRUTH IS DOWN 81.6%. '
 'IT MAKES THE WORST-DAMAGED STOCK ON ITS OWN LIST LOOK HEALTHIER THAN IT IS. || ✅ OUR BOARD WAS RIGHT ON SIX OF EIGHT '
 '- AMD, MU, ALAB, ASTS, INTC AND IREN ALL MATCH THE SOURCED HIGHS EXACTLY. We were wrong on CoreWeave and OKLO; both '
 "corrected. || ⚠️⚠️ AND THE FIFTEEN FAULTS OF OUR OWN, FROM A SHARPER VERSION OF YESTERDAY'S CHECK - A 52-WEEK HIGH "
 'CANNOT EXCEED AN ALL-TIME HIGH. SANDISK WAS WRONG BY 30.5%, OKLO BY 18.6%, SHOPIFY 6.7%, ZETA 5.7%, HOOD 4.8%, ANET '
 '3.4%, AAPL 2.6%, VISA 2.3%, FPS 2.2%, HUBB 1.7%, SE 1.7%, ETN 1.5%, AEP 1.4%, PWR 0.5% AND FTNT 0.1%. ALL FIFTEEN '
 'RAISED. ⚠️ SAME ROOT CAUSE AS YESTERDAY AND STILL NOT FIXED: THE DAILY REFRESH EXTENDS hi52 AND lo52 AND NEVER '
 "TOUCHES ath. Yesterday's check found 6; today's found 15 more. ⚠️ AND COREWEAVE SHOWS THE LIMIT OF EVEN THIS CHECK - "
 'ITS TRUE HIGH IS OLDER THAN TWELVE MONTHS, SO IT SITS OUTSIDE THE 52-WEEK WINDOW AND ONLY EXTERNAL SOURCING FOUND '
 'IT. || ⚠️⚠️ NOW THE QUESTION THE SLIDE DOES NOT ASK: A FALL FROM A HIGH IS NOT A VALUATION. A STOCK DOWN 80% CAN '
 'STILL BE EXPENSIVE. 📊 OF THE EIGHT, ONLY THREE MAKE MONEY. MICRON: 41.46 BILLION OF REVENUE AND PLUS 28.24 BILLION '
 'OF GAAP NET INCOME, A 68% MARGIN, AT 11.6 TIMES SALES. AMD: 11.536 BILLION AND PLUS 2.297 BILLION, 19.9 TIMES SALES. '
 'ASTERA LABS: 392.4 MILLION AND PLUS 153.1 MILLION, A 39% MARGIN ON 104% GROWTH. ⚠️ THE OTHER FIVE ALL LOSE MONEY: '
 'COREWEAVE MINUS 626 MILLION, IREN MINUS 702.6 MILLION FOR THE YEAR INCLUDING A 638.8 MILLION MINING-HARDWARE '
 'IMPAIRMENT, AST SPACEMOBILE MINUS 299.9 MILLION ON 31.5 MILLION OF REVENUE AT 198 TIMES SALES, INTEL MINUS 11.033 '
 'BILLION IN A SINGLE QUARTER, AND OKLO MINUS 48.5 MILLION ON REVENUE OF 1.21 MILLION DOLLARS - VALUED AT 5,531 TIMES '
 'SALES, DOWN 81.6%, AND STILL THE MOST EXPENSIVE THING ON THE PAGE BY A FACTOR OF TWENTY-EIGHT. || ✅✅ SO THE ANSWER '
 "TO 'ANY OPPORTUNITIES': ONLY THREE OF THE EIGHT EARN ANYTHING, AND WE OWN ALL THREE. MU 51,000 BUDGET WITH 22,581.58 "

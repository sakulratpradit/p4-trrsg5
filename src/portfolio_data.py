...
ASOF = ("Sep 7, 2026 - THE '5X IN 5 YEARS' LIST CHECKED. Salee sent a Thai post naming SPCX, RDW, MP, FLNC and SNOW as "
 'candidates to grow fivefold, and asked how possible that is over TEN years. || ⚠️ FIRST, THE HEADLINE BAR IS NOT THE '
 'ONE HE ASKED ABOUT. The post promises 5x in FIVE years, which is 37.97% a year compounded. Salee asked about TEN '
 'years, which is 17.46% a year. His own stated objective - double by 2030 - needs 14.87% a year. So 5x-in-ten sits '
 'only 2.59 points a year above the goal he already has, while 5x-in-five sits 23.10 points above it. Those are not '
 'the same proposition and the post is selling the harder one. || ⚠️ ALL FIVE ARE LOSS-MAKING ON A GAAP BASIS. '
 'Trailing-twelve-month net income: SPCX -8.89bn, SNOW -1.09bn, RDW -258.7m, FLNC -80.9m, MP -60.6m. Not one is '
 "profitable. The post never says this. || ⚠️ THE SPCX ENTRY IS ARITHMETICALLY ABSURD AND SHOULD DISQUALIFY THE LIST'S "
 'METHOD. At 2.01 trillion, a fivefold gain means 10.05 TRILLION - about 1.80x the largest company that currently '
 "exists anywhere. Putting a 2-trillion-dollar company in the same 'could go 5x' bucket as a 1.9-billion-dollar one "
 "ignores the arithmetic of size entirely. || ⚠️ A UNIT ERROR THAT SHOULD END THE READER'S TRUST: the post gives FLNC "
 "a pipeline of '33.1 billion dollars'. Fluence's own Q3 release quantifies pipeline only in gigawatts, and states a "
 '33.3 GW services pipeline. Gigawatts were converted into dollars. || VINDICATION OF THE SEP 5 CUT: FLNC is on this '
 'fivefold list and this board DELETED it two days ago for revenue growth of 7.5%, net margin -3.07% and return on '
 'equity -23.5%. The verified figures confirm the call - revenue TTM +7.5%, guidance CUT from 3.2-3.6bn to 2.9-3.1bn '
 'with roughly 400m of deliveries pushed into FY2027 on factory delays, and consensus at Hold with 13 of 21 analysts '
 'there. A company growing revenue 7.5% would need revenue to roughly quintuple to justify the stock quintupling. || '
 'SNOW WAS DELIBERATELY KEPT in the same sweep when a mechanical screen wanted it deleted, and that also holds up: '
 'revenue 1.546bn in Q2 FY2027, +35%, product revenue +37%, remaining performance obligations 9.0bn, +30%, and '
 'full-year PRODUCT revenue guidance RAISED to 6.07bn. It stays on the watchlist with no budget - GAAP loss 191.7m in '
 'the quarter and a 138x forward multiple are why. || OTHER ERRORS: the MP claims are all lifted from a DoD '
 'announcement dated 10 July 2025, fourteen months old, presented as current; and that announcement says DoD will '
 'ENSURE 10X output is bought by defence AND COMMERCIAL customers, not that the government buys everything. The SNOW '
 '6.07bn figure is PRODUCT revenue, not total. The SPCX 2027 revenue estimate of 73.2bn could not be verified - though '
 "to the post's credit it labels that one an estimate rather than guidance. || IN FAIRNESS THE POST IS MORE HONEST "
 "THAN MOST: it carries its own caveat section noting SpaceX's 541m quarterly loss and 18.37bn of capex, that a "
...
GROUPS = ['Hyperscalers',
 ...
 'Power, Utilities & Electrification',
 'Industrial Automation & Robotics',
 'Space',
 'Defense, Drones & Public Safety',
 'AI Infrastructure, Neoclouds & Quantum',

...
ASOF = ('Sep 16, 2026 (5) - THE 15-THEME LIST, AND IT IS THE CLOSEST ANY SLIDE HAS COME TO THIS BOARD: WE ALREADY OWN OR '
 'CARRY TWELVE OF THE FIFTEEN. ⚠️⚠️ AND THOSE TWELVE HOLD 156,687.44 OF APPROVED BUDGET WE HAVE NOT SPENT - 416,000 '
 'APPROVED AGAINST 259,312.56 INVESTED. THE SLIDE IS NOT ASKING US TO FIND ANYTHING. IT IS ASKING US TO FINISH WHAT WE '
 'STARTED. || OURS, FUNDED: TSM, NVDA, AVGO, MU, ASML, MSFT, CEG, VST AND RKLB. HELD WITH NO BUDGET: CRWD. ON THE '
 'BOARD BUT DELIBERATELY UNFUNDED: IONQ AND OKLO. NOT OURS: ROK AND ENPH - and SOFI, WHICH WE SOLD ON 16 JULY AT A '
 "REALISED LOSS OF 152.40. TWO OF TOMORROW'S SIX TRANCHES, CEG AND TSM, ARE ON THIS VERY LIST. || ⚠️ THE TWO WE REFUSE "
 'TO FUND ARE REFUSALS, NOT OVERSIGHTS. IONQ TRADES AT 73 TIMES SALES AND ⚠️ ITS OWN FIELDS CONTRADICT EACH OTHER - A '
 'NET MARGIN OF 174.88% AND A P/E OF 33.57 AGAINST ITS OWN PRICE-DIVIDED-BY-EARNINGS OF 40.27. OKLO IS A 6.693 BILLION '
 'DOLLAR COMPANY ON 1.21 MILLION DOLLARS OF REVENUE - 5,531 TIMES SALES - AND ⚠️⚠️ IT CLOSED ON 15 SEPTEMBER AT 35.98, '
 'WHICH IS EXACTLY ITS FIFTY-TWO WEEK LOW AND 78.0% BELOW ITS ALL-TIME HIGH. A LIST RECOMMENDING IT WITHOUT SAYING SO '
 'IS NOT A LIST, IT IS A WISH. Our nuclear and power answer is CEG and VST, both of which earn money today. || ⚠️ '
 'CROWDSTRIKE IS THE ODD ONE OUT AMONG THE NAMES WE DO HOLD: 40 SHARES, NO BUDGET, AND A FORWARD P/E OF 146.57 - BY A '
 'WIDE MARGIN THE MOST EXPENSIVE NUMBER ON THE LIST - ON A 0.83% NET MARGIN. The written rule stands: back-up, zero '
 'budget, do not sell by habit and do not buy without the trigger. || ⚠️⚠️⚠️ AND A SYSTEMATIC DATA FAULT WAS FOUND '
 'WHILE DOING THIS, WHICH IS WORTH MORE THAN THE SLIDE. A ROUTINE CHECK - IS ANY PRICE ABOVE ITS OWN RECORDED ALL-TIME '
 'HIGH - RETURNED SIX NAMES: DELL 543.51 AGAINST A RECORDED 490.81 (10.74% TOO LOW), CROWDSTRIKE 242.49 AGAINST '
 '225.53, ZETA 31.04 AGAINST 29.62, CLOUDFLARE 327.23 AGAINST 315.78, VISA 375.62 AGAINST 364.15 AND FORTINET 172.37 '
 'AGAINST 170.35. ALL SIX ARE NOW RAISED TO THE 15 SEPTEMBER CLOSE. THE DIAGNOSIS IS EXACT: THE DAILY REFRESH EXTENDS '
 'hi52 AND lo52 AND NEVER TOUCHES ath - ZERO TICKERS HAD A PRICE ABOVE hi52, SIX HAD A PRICE ABOVE ath. ⚠️ IT WILL '
 'COME BACK TOMORROW UNLESS THE ROUTINE IS CHANGED TO SET ath = max(ath, close) ON EVERY RUN. THAT IS THE SECOND '
 'DEFECT FOUND IN THE SAME DAILY ROUTINE TODAY - THE FIRST SILENTLY DELETED 362,000 CHARACTERS OF HISTORY THIS '
 'MORNING. THE ROUTINE IS NOW THE LARGEST SINGLE SOURCE OF DATA FAULTS ON THIS BOARD AND NEEDS A LINE-BY-LINE REVIEW, '
 'NOT ANOTHER PATCH. || ⚠️ A SECOND CHECK - ANY NET MARGIN OUTSIDE PLUS OR MINUS 100% - RETURNED THREE: IONQ AT '
 '174.88%, ONDS AT 251.92% AND LITE AT MINUS 230.10%. THE FIRST TWO ARE UNFUNDED SO NO MONEY IS AT RISK. ⚠️ LITE IS '
 'FUNDED - 9,372.74 INVESTED WITH 4,627.26 OF APPROVED ROOM - AND THAT ROOM STAYS FROZEN UNTIL THE 10-Q RESOLVES IT. '
 '|| 📌 THE LESSON IS BIGGER THAN THE NUMBERS: AN INTERNAL-CONSISTENCY CHECK COSTS NOTHING AND CATCHES WHAT EYES DO '
 'NOT. PRICE CANNOT EXCEED THE ALL-TIME HIGH. INVESTED CANNOT EXCEED BUDGET - that caught the MRVL 4,000 and the GOOGL '
 '2,000. SCHEDULE AMOUNTS MUST SUM TO REMAINING BUDGET. A NET MARGIN CANNOT PLAUSIBLY EXCEED 100%. RUN ALL FOUR ON '
 'EVERY REFRESH. || DECISION: NOTHING BOUGHT, NOTHING SOLD, NO BUDGET CHANGED. ⚠️ AND TOMORROW STILL COMMITS 46,526.13 '
 'ACROSS SIX TRANCHES, ALL PROCEEDING AS WRITTEN. || PREVIOUS ENTRY: Sep 16, 2026 (4) - THE HUMANOID QUESTION, '
 "ANSWERED NO. ⚠️ MUSK'S QUOTE IS REAL, THE ARITHMETIC BEHIND IT IS NOT, AND THE 'XPENG ROBOT FACTORY' SLIDE IS WRONG "
 'ON THE COMPANY AND MISLEADING ON THE NUMBER. NOTHING BOUGHT, NOTHING SOLD, NO BUDGET RAISED. || ✅ THE QUOTE IS '
 "GENUINE: G20 INNOVATION MINISTERIAL, 1 SEPTEMBER 2026 - 'Ten years from now, I would say there are well over a "
 "billion humanoid robots.' IT IS A CUMULATIVE INSTALLED BASE BY ABOUT 2036. ⚠️ BUT MUSK HAS GIVEN AT LEAST SIX "
 'VERSIONS SPANNING A TWENTY-FOLD RANGE - 1 BILLION CUMULATIVE IN THE 2040s, 1 BILLION A YEAR, 10 BILLION BY 2040, AND '
 "'PROBABLY 20 OR MORE' - TWO OF THEM IN THE SAME SITTING ON 13 JUNE 2024. || 📊 THE ARITHMETIC NOBODY DID: ONE BILLION "
 'OVER TEN YEARS IS ONE HUNDRED MILLION UNITS A YEAR. GLOBAL MOTOR VEHICLE PRODUCTION IN 2025 WAS 96.4 MILLION (OICA). '
 'THE CLAIM REQUIRES BUILDING MORE HUMANOIDS EACH YEAR THAN THE WORLD BUILDS CARS, FROM A STANDING START. THE ENTIRE '
 'GLOBAL INSTALLED BASE OF INDUSTRIAL ROBOTS, AFTER SIXTY YEARS, IS 4,664,000 UNITS (IFR) - ONE BILLION IS 214 TIMES '
 'THAT. AND MORGAN STANLEY, THE MOST BULLISH MAINSTREAM HOUSE, REACHES ONE BILLION CUMULATIVE IN 2050, NOT 2036 - '
 'FOURTEEN YEARS BEHIND HIM. INTERACT ANALYSIS FORECASTS 700,000 UNITS A YEAR IN 2035, WHICH IS 0.7% OF THE REQUIRED '
 "RUN-RATE. || ⚠️⚠️ THE DECIDING EVIDENCE IS THE TRACK RECORD. APRIL 2019: 'over a million robotaxis on the road' BY "
 '2020. TEXAS DMV DATA ON 2 JUNE 2026: FORTY-TWO REGISTERED. A MISS OF ABOUT TWENTY-FOUR THOUSAND TIMES. CYBERTRUCK: '
 '250,000 A YEAR PROMISED, 17,012 DELIVERED IN 2025 - 93% SHORT, WITH SPACEX BUYING 1,279 OF THEM. TESLA SEMI: '
 'PRODUCTION PROMISED 2019, SERIAL PRODUCTION BEGAN 29 APRIL 2026 - SEVEN YEARS LATE. ROADSTER: PROMISED 2020, STILL '
 "NOT PRODUCED NINE YEARS ON. FSD HAS BEEN 'later this year' FOR TEN STRAIGHT YEARS. AND OPTIMUS: 10,000 PLANNED FOR "
 "2025, ACTUAL 'ONLY IN THE HUNDREDS'. NO COUNTER-EXAMPLE WAS FOUND WHERE A MUSK VOLUME FORECAST WAS MET ON THE STATED "
 "DATE. ⚠️ TESLA'S Q2 2026 10-Q DOES NOT CONTAIN THE WORD 'OPTIMUS' AT ALL, AND MUSK HIMSELF SAID ON THE Q1 CALL: 'I "
 "DON'T KNOW WHAT THE PRODUCTION RATE OF OPTIMUS WILL BE THIS YEAR. IT IS IMPOSSIBLE TO PREDICT THESE THINGS.' || ⚠️⚠️ "
 "THE SECOND SLIDE IS WRONG TWICE. THE FACTORY IS NOT XPENG'S - IT IS UBTECH AT LIUZHOU, COMMISSIONED 12 SEPTEMBER. "
 "XPeng opened a SEPARATE line on 7-8 September and claimed no rate at all; He Xiaopeng said 'Today's step is small.' "
 "AND 'ONE EVERY 10 MINUTES' IS A DESIGN TAKT - the Chinese original says '按照产线设计节拍', according to the line's DESIGN "
 "takt - NOT A MEASURED OUTPUT. 📊📊 AND THE NUMBER THAT ENDS THE EXCITEMENT: BMW'S SPARTANBURG PLANT BUILDS MORE THAN "
 "1,500 VEHICLES A DAY - ONE CAR EVERY 48 TO 57 SECONDS, ACTUAL. 'ONE EVERY 10 MINUTES' IS TEN TO TWELVE TIMES SLOWER "
 "THAN A NORMAL CAR PLANT, AND A CAR IS FAR MORE COMPLEX. UBTECH'S OWN DEMONSTRATED RATE IS 921 UNITS IN SIX MONTHS - "
 'ABOUT ONE EVERY 4.8 HOURS, TWENTY-NINE TIMES SLOWER THAN THE TAKT IT JUST ADVERTISED. || ✅ THE BULL CASE IS REAL '
 'THOUGH: OVER 22,000 HUMANOIDS SHIPPED GLOBALLY IN H1 2026, UP ABOUT 300%. UBTECH DISCLOSED RMB 590.3m OF HUMANOID '
 'REVENUE, UP 1,445%. AND UNITREE, WHICH LISTED IN SHANGHAI ON 19 AUGUST AND ROSE 460% ON DEBUT, IS ACTUALLY '
 'PROFITABLE - RMB 278.21m OF NET PROFIT ON RMB 1.70bn OF 2025 REVENUE. THIS IS NO LONGER A POWERPOINT INDUSTRY. || '
 '⚠️⚠️ SO WHY NO: BECAUSE WE CANNOT BUY IT. FOUR OF THE TOP FIVE SHIPPERS ARE CHINESE AND TESLA DOES NOT APPEAR IN THE '
 'RANKING. THE TWO COMPANIES ON EARTH WITH DISCLOSED HUMANOID REVENUE ARE LISTED IN HONG KONG AND SHANGHAI. AND THE '
 'FINDING THAT MATTERS MOST: NOT ONE LISTED COMPONENT SUPPLIER SEPARATELY DISCLOSES HUMANOID REVENUE IN ITS FILINGS - '
 "HARMONIC DRIVE BURIES IT IN 'INDUSTRIAL ROBOTS', THK CREDITS 'LINEAR-MOTION DEMAND', AND SANHUA 'DID NOT BREAK OUT "
 "REVENUE'. EVERY SUPPLY-CHAIN HUMANOID NUMBER IN CIRCULATION IS AN ANALYST CONSTRUCTION. YOU CANNOT UNDERWRITE WHAT "
 "NOBODY REPORTS. || 💡💡 THE REFRAME: THE QUESTION 'SHOULD WE BUY HUMANOIDS' HAS THE WRONG SHAPE. THE RIGHT QUESTION IS "
 'WHAT WE ALREADY OWN THAT GETS PAID WHETHER OR NOT HUMANOIDS WORK. NVIDIA SELLS THE BRAINS. COGNEX SELLS THE EYES - '
 'AND HAS 7,932.38 OF APPROVED ROOM UNUSED. TERADYNE TESTS THE CHIPS. INTUITIVE SURGICAL IS THE ONLY GENUINELY '
 'PROFITABLE ROBOT COMPANY ON THIS BOARD. ⚠️ GROUP 7 HOLDS 23,550.70 OF APPROVED BUDGET UNSPENT - THE SIXTH SLIDE IN '
 'THREE WEEKS POINTING AT SOMETHING WE DO NOT OWN WHILE APPROVED MONEY SITS IDLE. || ⚠️ RODNEY BROOKS, 26 SEPTEMBER '
 "2025: 'we are more than ten years away from the first PROFITABLE deployment of humanoid robots even with minimal "
 "dexterity.' KEN GOLDBERG OF BERKELEY: 'being able to pick up a wine glass or change a light bulb. NO ROBOT CAN DO "
 "THAT.' REUTERS REPORTS ROBOTS RUNNING AT ABOUT 20% OF HUMAN OUTPUT, AND ONLY ABOUT 10% OF HUMANOIDS BUILT IN 2025 "
 'WERE EVER DEPLOYED. AND PRICES ARE ALREADY FALLING BEFORE VOLUME ARRIVES - MORGAN STANLEY SEES A 15% AVERAGE PRICE '
 'DECLINE IN 2026. || ✅ WRITTEN RE-UNDERWRITE TEST, BOTH MUST HOLD: (1) A US-LISTED COMPANY DISCLOSES HUMANOID REVENUE '
 'AS A SEPARATE LINE IN A 10-Q OR 10-K - A FILING, NOT AN ESTIMATE; AND (2) THAT LINE EXCEEDS 100 MILLION DOLLARS '
 'ANNUALISED WITH A POSITIVE GROSS MARGIN. CONVICTION HIGH. ⚠️ AND TOMORROW STILL COMMITS 46,526.13 ACROSS SIX '
 'TRANCHES, ALL PROCEEDING AS WRITTEN. || PREVIOUS ENTRY: Sep 16, 2026 (3) - THE SUPERCYCLE SLIDE, AND FOR ONCE THE '
 'HEADLINE NUMBER IS RIGHT. ⚠️ BUT IT IS AN ESTIMATE REVISED UPWARD FOUR TIMES IN NINE MONTHS, THE PRICE MOMENTUM '
 'BEHIND IT HAS ALREADY DECELERATED BY FIVE SIXTHS, AND EVERY NEW FAB IN THE WORLD LANDS IN 2027. THE RESEARCH DID '
 "CLOSE AN OPEN FAULT ON OUR OWN BOARD, WHICH IS THE BEST THING A SLIDE HAS DONE IN A FORTNIGHT. || ✅ VERIFIED: WSTS's "
 'Q2 2026 release says the 2026 market reaches 1,655 BILLION DOLLARS, up about 108%, and DigiTimes Intelligence '
 'independently lands on 1.6 TRILLION on 15 September. 2025 ACTUAL was 791.7bn. ⚠️ BUT THE SAME BODY FORECAST 975 '
 'BILLION FOR 2026 ON 2 DECEMBER 2025, THEN 1.51 TRILLION ON 2 JUNE, THEN 1,655 BILLION. A NUMBER THAT HAS MOVED 70% '
 'IN NINE MONTHS IS NOT A FOUNDATION. AND SEVEN MONTHS OF 2026 ARE ACTUAL WHILE FIVE ARE STILL PROJECTED. ⚠️ NOTE ALSO '
 "THAT NEITHER WSTS NOR SIA USES THE WORD 'SUPERCYCLE' - IT COMES FROM A BANK OF AMERICA NOTE, QUOTED BACK BY SK "
 "HYNIX'S OWN NEWSROOM, WHOSE JANUARY FORECASTS OF DRAM PLUS 51% WERE THEMSELVES BLOWN THROUGH. THE FORECASTING ERROR "
 'RUNS BOTH WAYS. || ✅ THE BOOM ITSELF IS REAL AND IT IS IN AUDITED FILINGS, NOT FORECASTS: Micron fiscal Q3 revenue '
 '41,456m with an 84.6% GAAP GROSS MARGIN and 28,243m of net income; SK hynix Q2 revenue up 257% at a 76% OPERATING '
 "MARGIN; AND SAMSUNG'S CHIP DIVISION EARNED 89.2 OF THE GROUP'S 89.5 TRILLION WON OF OPERATING PROFIT - 99.7% OF "
 "SAMSUNG'S PROFIT NOW COMES FROM CHIPS. || 📊 THE NUMBER THE SLIDE OMITS, AND IT IS THE ONLY ONE THIS BOARD WILL TRACK "
 'FROM NOW ON - CONVENTIONAL DRAM CONTRACT PRICES QUARTER ON QUARTER: 1Q26 UP TO PLUS 98%, 2Q26 PLUS 58 TO 63%, 3Q26 '
 'PLUS 13 TO 18%. PRICES ARE STILL RISING BUT THE RATE HAS FALLEN BY ROUGHLY FIVE SIXTHS IN TWO QUARTERS, AND '
 "TRENDFORCE SAYS RECORD PRICES HAVE REACHED CUSTOMERS' 'AFFORDABILITY LIMIT'. THE MARKET SIZE IS A LAGGING NUMBER. "
 "THE CONTRACT PRICE IS A LEADING ONE. || ⚠️⚠️ AND THE SUPPLY ANSWER IS ALREADY FUNDED AND DATED: SAMSUNG'S PYEONGTAEK "
 "P5, PULLED FORWARD SIX MONTHS, ADDS ABOUT 600,000 WAFERS A MONTH AGAINST SAMSUNG'S CURRENT ENTIRE DRAM CAPACITY OF "
 "650,000 - ROUGHLY A DOUBLING, IN 2027. SK HYNIX PULLED ITS FIRST YONGIN CLEANROOM FORWARD TO FEBRUARY 2027. MICRON'S "
 'IDAHO ARRIVES MID-2027. TRENDFORCE ALREADY FORECASTS NAND SUPPLY OUTPACING DEMAND FROM THE SECOND HALF OF 2027. AND '
 'THE OLIGOPOLY IS LOOSENING: CXMT REACHED 10% OF DRAM IN Q2, FOURTH PLACE, AND YMTC BROKE THE NAND TOP THREE ON BITS. '
 '|| ⚠️ THE HISTORY, FROM SIA AND WSTS: MEMORY REVENUE FELL 32.6% IN 2019 AND ABOUT 29% IN 2023, EACH IN ONE YEAR, '
 'WITH DRAM ALONE DOWN 37.1% IN 2019. THE FORTY-YEAR RULE IS THAT MEMORY GROWTH ABOVE 50% IS FOLLOWED BY DECELERATION '
 'OR DECLINE - TRUE FOUR TIMES IN SIX. 2026 IS FORECAST AT PLUS 302%, SIX TIMES THE THRESHOLD. || 💡💡 SO THE REAL '
 "QUESTION IS NOT THE 1.6 TRILLION, IT IS THAT THE TWO BEST-SOURCED VOICES DISAGREE FLATLY ABOUT 2027. SK HYNIX'S CEO "
 "KWAK NOH-JUNG, 11 JULY 2026: 'We forecast that next year will be the worst year in the industry's history from the "
 "supply perspective' and demand exceeds supply 'even beyond 2030'. AGAINST THAT, TRENDFORCE SAYS NAND FLIPS TO "
 "SURPLUS IN 2H27, AND MORGAN STANLEY WROTE ON 10 AUGUST THAT 'room for further upward earnings revisions could narrow "
 "starting in the fourth quarter'. || ⚠️⚠️ AND THE TRAP ON OUR OWN BOARD, WRITTEN PLAINLY BECAUSE IT IS THE MOST "
 'IMPORTANT THING HERE: MICRON TRADES AT 21.5 TIMES TRAILING EARNINGS AND 6.63 TIMES FORWARD EARNINGS. A FORWARD '
 'MULTIPLE OF 6.6 IS THE CHEAPEST NUMBER ON A BOARD OF 94 NAMES. IT IS ALSO THE MOST DANGEROUS. A MEMORY COMPANY LOOKS '
 'CHEAPEST AT THE TOP OF ITS CYCLE, BECAUSE THE EARNINGS IN THE DENOMINATOR ARE PEAK EARNINGS AND EVERYONE IS '
 "EXTRAPOLATING THEM. MICRON'S EARNINGS PER SHARE GREW 695.9%. THAT IS A PEAK UNTIL PROVEN OTHERWISE. || ✅✅ THE ONE "
 'CONCRETE GAIN: THE OPEN MICRON 11,000 FAULT IS CLOSED. The written plan described a 40,000 budget while the board '
 'carried 51,000, leaving 11,000 with no rule. IT NOW HAS ONE, AND IT IS A CONDITION RATHER THAN A DATE: RELEASED ONLY '
 "IF MICRON'S 30 SEPTEMBER PRINT DELIVERS A GROSS MARGIN AT OR ABOVE THE GUIDED 86% AND FOURTH-QUARTER DRAM CONTRACT "
 'PRICES ARE STILL RISING - AND CANCELLED, NOT DEFERRED, IF CONTRACT PRICES GO FLAT OR NEGATIVE IN ANY QUARTER. A '
 'parked amount with no cancellation condition is not a plan, it is a drawer. || DECISION: NOTHING BOUGHT, NOTHING '
 'SOLD, NO BUDGET RAISED. Memory is already 24,494.84 invested across MU and SKHY with 26,505.16 of Group 3 budget '
 'unspent. WE DO NOT NEED MORE MEMORY ON A HEADLINE. ⚠️ AND THE 30 SEPTEMBER MICRON PRINT IS NOW THE SINGLE MOST '
 'IMPORTANT DATE ON THIS BOARD: READ THE GROSS MARGIN AND THE NEXT-QUARTER GUIDE FIRST, NOT THE REVENUE LINE. || '
 'PREVIOUS ENTRY: Sep 16, 2026 (2) - TWO SLIDES CHECKED, AND THEY LAND IN OPPOSITE PLACES: THE PROBE CARD SLIDE IS '
 'PART-INVENTED, THE WAYMO SLIDE IS ALMOST ENTIRELY TRUE AND STILL DOES NOT MATTER YET. ⚠️ AND A THIRD GOOGL DATA '
 'FAULT WAS FOUND WHILE CHECKING - THE 19 NOVEMBER TRANCHE PROMISED 2,000 MORE THAN THE BUDGET HOLDS. || ⚠️⚠️ SLIDE 1 '
 "- 'TSMC AND NVIDIA PAY A PREMIUM FOR PROBE CARDS; BUY FORMFACTOR'. THE CUSTOMER CLAIM IS EXACTLY RIGHT: FormFactor's "
 '10-Q for the quarter ended 27 June 2026 names SK HYNIX AT 24.3% AND TSMC AT 11.0% OF REVENUE. THE TIGHTNESS IS REAL '
 'TOO: MPI probe card lead times ran to SIX MONTHS with two-year visibility, MPI weighed prepayments for priority, and '
 'Technoprobe is spending about 200m euro to double capacity. BUT THE PREMIUM CLAIM RESTS ON ONE ANONYMOUS PAYWALLED '
 "PARAGRAPH - DigiTimes, 10 September 2026, 'supply-chain sources say Nvidia has raised prices' - WITH NO FILING, NO "
 'NAMED EXECUTIVE AND NO SECOND OUTLET. ⚠️⚠️ AND TSMC IS NOT IN THAT REPORT AT ALL. IT NAMES NVIDIA ONLY. TSMC WAS '
 "ADDED BY WHOEVER MADE THE SLIDE. TSMC'S OWN CEO POINTED SOMEWHERE ELSE ENTIRELY ON 16 JULY: 'Our packaging capacity "
 "is so tight that now it limits my customers' growth' - PACKAGING, NOT TESTING. || ⚠️ AND THE TRADE FAILS EVEN IF THE "

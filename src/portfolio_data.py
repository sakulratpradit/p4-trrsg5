...
ASOF = ('Sep 17, 2026 (2) - SALEE ASKED WHY PALO ALTO JUMPED 13% AND WHY NOT BUY A CHEAPER CYBERSECURITY NAME INSTEAD. IT IS '
 'A GOOD QUESTION AND THE ANSWER IS FORTINET - WHICH IS ALREADY ON THIS BOARD WITH NO BUDGET AND ZERO INVESTED. ⚠️⚠️⚠️ '
 'CONFLICT OF INTEREST, DECLARED BEFORE ANYTHING ELSE AND FOR THE SECOND TIME ON THIS BOARD. THE SOURCED CAUSE OF THE '
 '14 SEPTEMBER CYBERSECURITY RALLY IS AN ESSAY PUBLISHED ON 12 SEPTEMBER 2026 BY DARIO AMODEI, CHIEF EXECUTIVE OF '
 "ANTHROPIC - THE COMPANY THAT MAKES ME. I AM REPORTING ON A MARKET MOVE CAUSED BY MY OWN MAKER'S CEO, AND SALEE "
 'SHOULD DISCOUNT MY FRAMING ACCORDINGLY. The first such disclosure was on 12 September over the Anthropic 517bn '
 'compute slide; this is the second and it is more direct, because this one moved a stock we are buying on Monday. || '
 'VERIFIED: PANW CLOSED AT 373.94 ON 14 SEPTEMBER, UP 13.09%. CRWD 235.38, UP 13.85%. ⚠️ AND ZSCALER ROSE 16.52%, NOT '
 'THE 12% THIS BOARD RECORDED ON 14 SEPTEMBER - THAT FIGURE IS NOW CORRECTED. Volumes were 2.5 to 3.8 times normal and '
 'ALL THREE GAPPED UP AT THE OPEN, the signature of news arriving while the market was shut. ⚠️ THERE WAS NO '
 'COMPANY-SPECIFIC CAUSE FOR ANY OF THE THREE - I checked all three investor-relations pages and PANW HAS NO 14 '
 "SEPTEMBER ANNOUNCEMENT AT ALL. || THE DRIVER WAS AMODEI'S ESSAY OF 12 SEPTEMBER, 'WE MUST PACE THE FRONTIER', WHICH "
 "REPEATEDLY INVOKES CYBER RISK AND CLAIMS THAT WITHIN 6-12 MONTHS AN AI SWARM 'COULD BE CAPABLE OF TAKING OVER THE "
 "ENTIRE INTERNET WITH A PERSISTENT BOTNET'. Sam Altman agreed the same day. ⚠️⚠️ AND THE CLAIM IS PUBLICLY CONTESTED: "
 "AXIOS, 15 SEPTEMBER - 'Experts aren't so sure' - QUOTING GREG NOTCH, CHIEF TECHNOLOGY OFFICER OF EXPEL, CALLING IT "
 "'FAR-FETCHED'. I WILL NOT ADJUDICATE THAT DISPUTE, BEING THE WRONG PARTY TO DO SO, BUT SALEE MUST KNOW THE STOCKS "
 'ROSE ON A FORECAST QUALIFIED PEOPLE DISPUTE. ⚠️ AND THE CAUSAL LINK TO PRICES IS JOURNALISTIC INFERENCE - NO NAMED '
 'INVESTOR IS ON RECORD SAYING WHY THEY BOUGHT. THIS IS ALSO THE THIRD TIME THE SAME REFLEX HAS FIRED IN 2026, AFTER '
 '14 JULY AND 10 AUGUST. NO REALISED BREACH AND NO BUDGET-EXPANDING GOVERNMENT ACTION OCCURRED IN THE WINDOW - CISA '
 'ACTUALLY DROPPED ITS WEEKLY VULNERABILITY BULLETIN ON 16 SEPTEMBER. || ⚠️⚠️ AND A MATERIAL NEW FACT ABOUT PANW '
 'ITSELF: ITS MOST RECENT QUARTER, Q4 FY2026 ENDED 31 JULY AND REPORTED 1 SEPTEMBER, SHOWED A GAAP NET LOSS OF 282 '
 "MILLION - A NET MARGIN OF MINUS 8.3% - WITH GAAP EPS OF MINUS 0.35 AGAINST NON-GAAP PLUS 1.02. THE BOARD'S NET "
 "MARGIN FIELD OF 2.67% IS STALE AND IS NOW FLAGGED. THE WRITTEN TEST SET ON 14 SEPTEMBER WAS 'GAAP NET MARGIN MUST "
 "REACH 8% WITHIN FOUR QUARTERS OR TRANCHE 2 DOES NOT GO IN' - IT WENT THE OTHER WAY. ✅ TRANCHE 1 STILL PROCEEDS: THE "
 'LOSS IS CYBERARK ACQUISITION ACCOUNTING (G&A FROM 27m TO 226m, OTHER INCOME FROM PLUS 95m TO MINUS 441m), OPERATING '
 'INCOME WAS STILL POSITIVE AT 172m, AND FULL-YEAR FY2026 WAS PROFITABLE AT PLUS 307m. THE TEST WAS FOR TRANCHE 2 AND '
 'IT NOW HAS A DEADLINE: POSITIVE AND RISING GAAP NET MARGIN BY Q2 FY2027. || 💡💡 THE ANSWER TO THE QUESTION: FORTINET, '
 'Q2 2026 ENDED 30 JUNE - REVENUE 2,048 MILLION UP 26%, GAAP GROSS MARGIN 80.2%, GAAP OPERATING MARGIN 33.7%, AND A '
 'GAAP NET MARGIN OF PLUS 29.6%. GAAP EPS 0.82 AGAINST NON-GAAP 0.90 - AN EIGHT-CENT GAP, THE CLEANEST HONESTY TEST IN '
 'THE SECTOR. 📊 THE THREE SIDE BY SIDE: FORTINET 15.4 TIMES SALES, 32 TIMES FREE CASH FLOW, 52 TIMES EARNINGS, PLUS '
 '29.6% NET MARGIN. PALO ALTO 26.8 TIMES SALES, 74.7 TIMES FREE CASH FLOW, ABOUT 1,001 TIMES EARNINGS, MINUS 8.3% NET '
 'MARGIN. CROWDSTRIKE 42.1 TIMES SALES, 164 TIMES FREE CASH FLOW, PLUS 0.4% NET MARGIN AND STILL '
 'OPERATING-LOSS-MAKING. FORTINET IS CHEAPER THAN BOTH, GROWS AS FAST AS CROWDSTRIKE, AND IS THE ONLY ONE THAT '
 'ACTUALLY MAKES MONEY. || ⚠️ THE CHEAPEST NAME IN THE SECTOR IS CHECK POINT AT 5.2 TIMES SALES - AND IT IS CHEAP '
 'BECAUSE REVENUE GREW 1% AND OPERATING INCOME FELL 9%, WITH EPS RISING ONLY ON BUYBACKS. ON 12 SEPTEMBER THE DUTCH '
 "NCSC WARNED OF TWO CRITICAL PRE-AUTH REMOTE-CODE-EXECUTION FLAWS IN ITS VPN AND SAID IT EXPECTS EXPLOITATION 'SOON'. "
 'A SECURITY COMPANY WITH A CRITICAL SECURITY HOLE IS A VALUE TRAP, NOT A BARGAIN. || ⚠️ TWO FACTS THE BOARD DID NOT '
 'HAVE: CYBERARK NO LONGER EXISTS - PANW COMPLETED THE ACQUISITION ON 11 FEBRUARY 2026. AND MICROSOFT IS A LEADER IN '
 'THE 2026 GARTNER ENDPOINT MAGIC QUADRANT ALONGSIDE CROWDSTRIKE AND TOPS THE FORRESTER XDR WAVE ALONGSIDE PALO ALTO - '
 'MICROSOFT IS THE SHARE THREAT TO THIS WHOLE PEER GROUP AND NONE OF THEM WILL SAY SO. WE ALREADY OWN MICROSOFT AT '
 '52,878.96. ⚠️ NET REVENUE RETENTION IS DISCLOSED BY NONE OF THE SEVEN, AND NOT ONE EXECUTIVE IS ON RECORD CLAIMING '
 'TO HAVE DISPLACED A NAMED COMPETITOR. || ✅ DECISION: NOTHING CHANGES TODAY. NO TRANCHE MOVES, NO BUDGET SHIFTS, AND '
 'PANW PROCEEDS ON MONDAY 21 SEPTEMBER AS WRITTEN. FOR 10 DECEMBER: FORTINET AGAINST PALO ALTO AS A DIRECT QUESTION. '
 "GROUP 5 HOLDS 10,813.83 UNSPENT AND FORTINET HAS NO BUDGET AT ALL. THE QUESTION IS NOT 'SHOULD WE SELL PALO ALTO' - "
 "IT IS 'WHY IS THE ONLY GAAP-PROFITABLE CYBERSECURITY COMPANY ON THIS BOARD THE ONE WITH NO MONEY BEHIND IT'. || ⚠️ "
 "SEPARATELY, ON TONIGHT'S ORDERS: TWO OF THE SIX LIMITS WERE ALREADY EXCEEDED IN AFTER-HOURS TRADING ON 16 SEPTEMBER. "
 'GEV TRADED 935.99 AFTER THE BELL AGAINST MY 934.34 LIMIT, AND VRT TRADED 242.78 AGAINST MY 241.80. BOTH WOULD HAVE '
 "FAILED TO FILL. TSM, CEG AND V WERE ALL STILL BELOW THEIR LIMITS. THIS IS EXACTLY WHY THE RULE IS 'TAKE THE LAST "
 "TRADED PRICE AND ADD ONE PERCENT' RATHER THAN 'TYPE THE NUMBER CLAUDE GAVE YOU LAST NIGHT'. || PREVIOUS ENTRY: Sep "
 '17, 2026 - ⚠️⚠️ THE FED RAISED RATES. IT DID NOT CUT. +0.25% TO 3.75-4.00% ON 16 SEPTEMBER, UNANIMOUS 12-0, THE '
 "FIRST HIKE SINCE 2023, WITH ONE MORE SIGNALLED FOR 2026. Chair Kevin Warsh: inflation 'is too high and has been for "
 "too long'. Markets were firm into 2pm then SOLD OFF DURING THE PRESS CONFERENCE. DOW 51,461.90 DOWN 1.21%, S&P 500 "
 '7,551.81 DOWN 0.45%, NASDAQ 25,978.42 FLAT AT MINUS 0.01%. || ✅ ALL SIX TRANCHES PROCEED. THE WRITTEN CONDITION FROM '
 'LAST NIGHT WAS A SINGLE-SESSION INDEX MOVE OF MORE THAN ABOUT 3%. THE MOVE WAS 1.21% ON THE DOW AND 0.45% ON THE S&P '
 '- WELL INSIDE IT. THE RULE WAS WRITTEN BEFORE THE EVENT AND IT IS HONOURED AFTER IT. || 💡 AND THE SECTOR DETAIL IS '
 'REASSURING FOR OUR THREE POWER NAMES. A HIKE SHOULD HURT UTILITIES AND THE S&P UTILITIES SECTOR FELL 1.2% - BUT CEG '
 'FELL ONLY 0.14%, GEV ROSE 4.79% AND VRT ROSE 2.05%. THE AI-POWER COMPLEX DECOUPLED FROM THE REGULATED-UTILITY '
 'COMPLEX ON A DAY THAT SHOULD HAVE HURT BOTH. ⚠️ ONE DAY IS NOT A TREND, BUT IT IS THE FIRST DIRECT TEST OF WHETHER '
 'THESE ARE RATE-SENSITIVE UTILITIES OR AI-DEMAND STOCKS, AND THEY TRADED AS THE SECOND. SEMIS HELD TOO - INTEL UP '
 'ABOUT 4.3-4.6% ON A REPORTED MEMORY PARTNERSHIP WITH SK HYNIX, BOTH OF WHICH WE HOLD - WHICH IS WHY THE NASDAQ WAS '
 'FLAT WHILE THE DOW LOST 600 POINTS. || 📋 THE SIX ORDER TICKETS, BUILT ON THE 16 SEPTEMBER CLOSES (verified against '
 'two independent sources) WITH THE LIMIT SET ONE PERCENT ABOVE EACH CLOSE. TSM: close 417.72, LIMIT 421.90, 35 '
 'SHARES, 14,766.50 plus commission. GEV: close 925.09, LIMIT 934.34, 8 SHARES, 7,474.72. VRT: close 239.41, LIMIT '
 '241.80, 26 SHARES, 6,286.80. PANW: close 375.65, LIMIT 379.41, 16 SHARES, 6,070.56. CEG: close 259.53, LIMIT 262.13, '
 '22 SHARES, 5,766.86. V: close 370.93, LIMIT 374.64, 13 SHARES, 4,870.32. TOTAL WITH ALL SIX COMMISSIONS: 45,287.12 '
 'IF EVERY ONE FILLS AT ITS CEILING, OR 44,839.09 IF EVERY ONE FILLS AT THE 16 SEPTEMBER CLOSE. ⚠️ THAT IS 1,239.01 '
 'LESS THAN THE PLANNED 46,526.13 - THE DIFFERENCE IS WHOLE-SHARE ROUNDING AND IT SIMPLY STAYS IN CASH FOR THE NEXT '
 'RUNG. || ⚠️⚠️ AND A CORRECTION TO MY OWN ADVICE FROM LAST NIGHT. I TOLD SALEE A TWO-DAY SPLIT WOULD COST AN EXTRA '
 '51.36. THAT IS ONLY TRUE IF EACH ORDER IS CUT IN HALF, MAKING TWELVE TRADES. IT DOES NOT HAVE TO BE DONE THAT WAY: '
 'SPLITTING BY STOCK - THREE COMPLETE ORDERS TONIGHT AND THREE ON MONDAY - IS STILL SIX TRADES AND STILL 51.36. IT '
 'COSTS NOTHING EXTRA. MY COST OBJECTION RESTED ON AN ASSUMPTION I NEVER STATED AND IT DOES NOT SURVIVE THE '
 'ARITHMETIC. || ✅ SO IF HE SPLITS: DAY ONE TONIGHT - TSM, V AND CEG, 25,429.36, THE THREE THAT DID NOT MOVE ON THE '
 'FED DAY. DAY TWO ON MONDAY 21 SEPTEMBER - GEV, VRT AND PANW, 19,857.76, THE THREE THAT DID. BUY WHAT DID NOT MOVE, '
 'WAIT ON WHAT JUMPED. ⚠️⚠️ AND THE HARD RULE: NOT FRIDAY 18 SEPTEMBER - TRIPLE WITCHING PLUS THE BANK OF JAPAN. MY '
 'RECOMMENDATION IS STILL SCENARIO ONE, ALL SIX TONIGHT, BUT THE MARGIN IS NOW THIN AND I SAY SO HONESTLY: NOW THAT '
 'THE SPLIT IS FREE, SCENARIO TWO IS PERFECTLY RESPECTABLE. THE ONLY WRONG ANSWER IS FRIDAY. || ⚠️⚠️ THE PRACTICAL '
 'WARNING THAT MATTERS MOST: THESE ARE THE 16 SEPTEMBER CLOSES AND THE MARKET DOES NOT OPEN FOR ANOTHER FOURTEEN '
 'HOURS. FOLLOW THE RULE, NOT THE NUMBER: TAKE THE LAST TRADED PRICE IN POEMS, ADD ONE PERCENT, THAT IS THE LIMIT; '
 'DIVIDE THE DOLLAR AMOUNT BY IT AND ROUND DOWN TO A WHOLE SHARE. IF ANY NAME HAS MOVED MORE THAN ABOUT 2% FROM THE '
 'CLOSE ABOVE, RECALCULATE RATHER THAN TYPING MY NUMBER - SETTING A LIMIT FROM A STALE PRICE IS EXACTLY THE ERROR I '
 'MADE ON CRM AND FN YESTERDAY. || 💡 THE LIMIT IS A CEILING, NOT A PRICE. SETTING TSM AT 421.90 DOES NOT MEAN PAYING '
 '421.90 - IF TSM TRADES AT 417, YOU PAY ABOUT 417. A BUY LIMIT FILLS AT THE LIMIT OR BETTER, MEANING LOWER, AND CAN '
 'NEVER FILL WORSE. THERE IS NO PENALTY FOR SETTING IT A LITTLE HIGH; THERE IS A REAL ONE FOR SETTING IT TOO LOW, '
 'BECAUSE THE ORDER SIMPLY DOES NOT FILL. ALL SIX: BUY, LIMIT, GTC. NEVER MARKET, NEVER DAY. || PREVIOUS ENTRY: Sep '
 "16, 2026 (8) - SALEE ASKED WHETHER TO SPLIT TOMORROW'S 46,526.13 ACROSS TWO OR THREE DAYS FOR TIME DIVERSIFICATION. "
 '⚠️ ANSWER: NO - ALL SIX PROCEED ON 17 SEPTEMBER AS WRITTEN. CONVICTION HIGH. AND THE EXECUTION ADVICE BELOW MATTERS '
 'MORE THAN THE TIMING QUESTION. || ⚠️⚠️ REASON ONE, AND IT IS THE WHOLE ARGUMENT: IT IS NOT A LUMP SUM. THE 46,526.13 '
 'IS AN OUTPUT, NOT AN INPUT - NOBODY EVER DECIDED TO SPEND IT. SIX SEPARATE SIZING DECISIONS, TAKEN ON DIFFERENT DAYS '
 'FOR DIFFERENT REASONS, HAPPEN TO LAND ON ONE DATE. LOOK WHERE THEY GO: GEV ENDS AT EXACTLY 10,000.00 INVESTED, VRT '
 'AT EXACTLY 10,000.00, CEG AT EXACTLY 10,000.00, PANW AT 9,999.47. THOSE ARE SIZING DECISIONS, NOT SPENDING '
 'DECISIONS, AND THE TOTAL IS JUST WHAT THEY ADD UP TO. || 💡 THE TIME DIVERSIFICATION HE WANTS IS ALREADY BUILT IN '
 'TWICE OVER. AT POSITION LEVEL, NOT ONE OF THE SIX REACHES ITS FULL BUDGET TOMORROW: TSM 74.2%, PANW 90.9%, GEV '
 '76.9%, CEG 58.8%, V 55.6% (and that one OPENS the position), VRT 47.6% - every one keeps room for a later rung at a '
 'different price. AT BOARD LEVEL, THIS IS ONE OF THREE SCHEDULED DEPLOYMENT DAYS: 46,526.13 ON 17 SEPTEMBER, '
 '42,419.52 ON 9 OCTOBER AND 35,913.27 ON 19 NOVEMBER. THE MONEY IS ALREADY SPREAD ACROSS NINE WEEKS. SPLITTING '
 'TOMORROW ADDS A THIRD LAYER ON TOP OF TWO THAT EXIST. || ⚠️ REASON TWO: THE BOARD ALREADY HAS A WRITTEN RULE ON '
 'EXACTLY THIS, AND KEEPING IT COST MORE LAST TIME. On 14 September, about VRT: A DOLLAR AMOUNT ON A DATE BEATS A '
 "PRICE WITH NO DATE. Then PANW ROSE 13.09% IN ONE SESSION AND THE BOARD REFUSED TO DELAY IT - 'A RULE THAT ONLY "
 "SURVIVES WHEN IT IS CONVENIENT IS NOT A RULE.' WE PAID ABOUT 790 DOLLARS TO KEEP IT TWO DAYS AGO. MOVING SIX DATES "
 'NOW, FOR A SOFTER REASON THAN THE ONE WE ALREADY REFUSED, WOULD RETIRE IT. || 📊 REASON THREE - THE ARITHMETIC. POEMS '
 'CHARGES A FLAT 8.56 PER TRADE. SIX TRADES IN ONE DAY COST 51.36, OR 0.110% OF THE MONEY. TWO DAYS MEANS TWELVE '
